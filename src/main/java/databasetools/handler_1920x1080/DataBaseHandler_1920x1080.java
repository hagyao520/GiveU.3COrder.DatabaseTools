...
public class DataBaseHandler_1920x1080 {
	    ...
	    try {
	         ...
	         ResultSetMetaData rsmd = rs.getMetaData(); // 获得rs结果集中列属性信息
	             ...
	             for (int i = 1; i <= rsmd.getColumnCount(); ++i)
	               ...
	               TableViewInquiryContract_1920x1080(tabDemo);   
	                close(sm,rs);
	      }catch (SQLException e) {
...
//			    + " and rownum<10000";
     ...
     * @param table 
     */  
	public static void TableViewInquiryContract_1920x1080(JTable tabDemo){  
        ...
        databasetools.ui.frame_1920x1080.InquiryContract_1920x1080.DataDisplayList.getViewport().add(tabDemo); 
	...
	public static void TableViewOneTouchCredit_1920x1080(JTable tabDemo){  
        ...
        fitTableColumns(tabDemo);
        //将JTable加入到带纵向滚动条的面板中
        databasetools.ui.frame_1920x1080.OneTouchCredit_1920x1080.DataDisplayList.getViewport().add(tabDemo); 
