...
//        response1.print();
     ...
     * @throws Exception
     */
    public static String GetJsonValue(String ApiUrl, String Param, Map<String, String> Cookie, String Value,String Value1) throws Exception{
        ...
        String Value2 = jsonPath.getString(Value1);
