package databasetools.ui.frame_1920x1080;
...
import databasetools.handler_1920x1080.ApiHandler1_1920x1080;
import databasetools.handler_1920x1080.ApiHandler_OneTouchCredit_1920x1080;
import databasetools.handler_1920x1080.DataBaseHandler1_1920x1080;
import databasetools.util.*;

@SuppressWarnings("serial")
public class OneTouchCredit1_1920x1080 extends JFrame{
...
//	private JTextField Other_relationTypeIDTextField;
	...
	public static OneTouchCredit1_1920x1080 getInstance() {
		OneTouchCredit1_1920x1080 inst = new OneTouchCredit1_1920x1080();
		inst.setLocationRelativeTo(null);
		inst.setVisible(true);
		return inst;
	}
	
	public OneTouchCredit1_1920x1080() {
		super();
		initGUI();
//		initTrayIcon();
		initFocusListener();
	...
	private void initGUI() {
	    ...
	    try {			
			...
			DefinitionJScrollPane(730, 10, 900, 710);
			...
			UserBoundStoreButton.setBounds(10, 40, 180, 25);
	    	...
	    	UserBoundStoreTextField.setBounds(510, 40, 210, 25);
...
//			,null,null,null,null,null,null,null,null,null);
	    	...
	    	StoreBoundCommodityTypeButton.setBounds(10, 70, 180, 25);
            ...
            StoreBoundCommodityTypeTextField.setBounds(510, 70, 210, 25);
...
//		    CommodityTypeText15,CommodityTypeText16,CommodityTypeText17,null,null,null,null,null,null,null,null,null);
            ...
            StoreBoundProductVersionButton.setBounds(10, 100, 180, 25);
	    	...
	    	StoreBoundProductVersionTextField.setBounds(510, 100, 210, 25);
...
//            ProductVersionText6,ProductVersionText7,ProductVersionText8,ProductVersionText9,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null);
            ...
            StoreBoundProductTypeButton.setBounds(10, 130, 180, 25);
            StoreBoundProductTypeButton.setFont(Constants.BASIC_FONT4);
	    	MainPanel.add(StoreBoundProductTypeButton);

	    	StoreBoundProductTypeTextField = new JTextField();
	    	StoreBoundProductTypeTextField.setBounds(510, 130, 210, 25);
	    	StoreBoundProductTypeTextField.setBorder(Constants.LIGHT_GRAY_BORDER);
	    	StoreBoundProductTypeTextField.setText("1");
	    	StoreBoundProductTypeTextField.setFont(Constants.BASIC_FONT4);
...
//            		null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null);   		    	
            ...
            ProductInforMationButton.setBounds(10, 160, 180, 85);
	    	...
	    	ProductInforMationStorIdTextField.setBounds(200, 160, 120, 25);
	    	ProductInforMationStorIdTextField.setBorder(Constants.LIGHT_GRAY_BORDER);
	    	ProductInforMationStorIdTextField.setText("91337");
	    	ProductInforMationStorIdTextField.setFont(Constants.BASIC_FONT4);
			...
			ProductInforMationgoodsCategoryIdTextField.setBounds(330, 160, 120, 25);
			...
			ProductInforMationgoodsCategoryIdTextField.setFont(Constants.BASIC_FONT4);
			...
			ProductInforMationSearchTypeIdTextField.setBounds(460, 160, 120, 25);
			...
			ProductInforMationSearchTypeIdTextField.setFont(Constants.BASIC_FONT4);
			...
			ProductInforMationProductTypeIdTextField.setBounds(590, 160, 130, 25);
			...
			ProductInforMationProductTypeIdTextField.setFont(Constants.BASIC_FONT4);
			...
			ProductInforMationPriceTextField.setBounds(200, 190, 120, 25);
			ProductInforMationPriceTextField.setBorder(Constants.LIGHT_GRAY_BORDER);
			ProductInforMationPriceTextField.setText("5000");
			ProductInforMationPriceTextField.setFont(Constants.BASIC_FONT4);
			...
			ProductInforMationFirstPayTextField.setBounds(330, 190, 120, 25);
			...
			ProductInforMationFirstPayTextField.setFont(Constants.BASIC_FONT4);
			...
			ProductInforMationIsWalletTextField.setBounds(460, 190, 120, 25);
			ProductInforMationIsWalletTextField.setBorder(Constants.LIGHT_GRAY_BORDER);
			ProductInforMationIsWalletTextField.setText("0");
			ProductInforMationIsWalletTextField.setFont(Constants.BASIC_FONT4);
			...
			ProductInforMationTextField.setBounds(590, 190, 130, 25);
			ProductInforMationTextField.setBorder(Constants.LIGHT_GRAY_BORDER);
			ProductInforMationTextField.setText("3");
			ProductInforMationTextField.setFont(Constants.BASIC_FONT4);
...
//            		null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null);	    	
            ...
            TypeBoundGoodsButton.setBounds(10, 250, 180, 25);
            TypeBoundGoodsButton.setFont(Constants.BASIC_FONT4);
	    	MainPanel.add(TypeBoundGoodsButton);

	    	TypeBoundGoodsGoodsTypeIdTextField = new JTextField();
	    	TypeBoundGoodsGoodsTypeIdTextField.setBounds(200, 250, 150, 25);
	    	TypeBoundGoodsGoodsTypeIdTextField.setBorder(Constants.LIGHT_GRAY_BORDER);
	    	TypeBoundGoodsGoodsTypeIdTextField.setText("7");
	    	TypeBoundGoodsGoodsTypeIdTextField.setFont(Constants.BASIC_FONT4);
	    	...
	    	TypeBoundGoodsTextField.setBounds(360, 250, 150, 25);
	    	TypeBoundGoodsTextField.setBorder(Constants.LIGHT_GRAY_BORDER);
	    	TypeBoundGoodsTextField.setText("1");
	    	TypeBoundGoodsTextField.setFont(Constants.BASIC_FONT4);
...
//            		null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null);  
			...
			GoodsBoundBrandsButton.setBounds(10, 280, 180, 25);
			GoodsBoundBrandsButton.setFont(Constants.BASIC_FONT4);
	    	MainPanel.add(GoodsBoundBrandsButton);

	    	GoodsBoundBrandsGoodsSubTypeValueTextField = new JTextField();
	    	GoodsBoundBrandsGoodsSubTypeValueTextField.setBounds(200, 280, 95, 25);
	    	...
	    	GoodsBoundBrandsGoodsSubTypeValueTextField.setFont(Constants.BASIC_FONT4);
			...
			GoodsBoundBrandsGoodsTypeIdTextField.setBounds(305, 280, 95, 25);
			GoodsBoundBrandsGoodsTypeIdTextField.setBorder(Constants.LIGHT_GRAY_BORDER);
			GoodsBoundBrandsGoodsTypeIdTextField.setText("7");
			GoodsBoundBrandsGoodsTypeIdTextField.setFont(Constants.BASIC_FONT4);
			...
			GoodsBoundBrandsTextField.setBounds(410, 280, 100, 25);
			GoodsBoundBrandsTextField.setBorder(Constants.LIGHT_GRAY_BORDER);
			GoodsBoundBrandsTextField.setText("1");
			GoodsBoundBrandsTextField.setFont(Constants.BASIC_FONT4);
...
//	        GoodsBoundBrandsBox.setBounds(520, 280, 200, 25);
...
//			MainPanel.add(ProductCodeTextField);
			...
			IdentPhoneBackTextField.setFont(Constants.BASIC_FONT4);
			IdentPhoneBackTextField.setForeground(Color.GRAY); 
			MainPanel.add(IdentPhoneBackTextField);
			
			DefinitionJLabel(IdentPhoneFront,"身份证反面照",350, 370+120, 200, 20);
			IdentPhoneFrontTextField = new JTextField();
			IdentPhoneFrontTextField.setBounds(480, 368+120, 240, 25);
            ...
            DefinitionJLabel(liveInfo,"现居住地所属地址",11, 800, 200, 20);
	    	liveInfo_ProvinceTextField = new JTextField();
	    	liveInfo_ProvinceTextField.setBounds(160, 798, 50, 25);
	    	liveInfo_ProvinceTextField.setBorder(Constants.LIGHT_GRAY_BORDER);
	    	liveInfo_ProvinceTextField.setText("山西");
	    	liveInfo_ProvinceTextField.setFont(Constants.BASIC_FONT4);
			...
			liveInfo_CityTextField.setBounds(215, 798, 50, 25);
			liveInfo_CityTextField.setBorder(Constants.LIGHT_GRAY_BORDER);
			liveInfo_CityTextField.setText("临汾");
			liveInfo_CityTextField.setFont(Constants.BASIC_FONT4);
			...
			DefinitionJLabel(flowType,"流式",1640, 200, 180, 20);
			flowTypeTextField = new JTextField();
			flowTypeTextField.setBounds(1750, 200, 160, 25);
			flowTypeTextField.setBorder(Constants.LIGHT_GRAY_BORDER);
			flowTypeTextField.setText("10");
			flowTypeTextField.setFont(Constants.BASIC_FONT4);
			flowTypeTextField.setForeground(Color.GRAY); 
			MainPanel.add(flowTypeTextField);
			
			DefinitionJLabel(photoType,"图片类型",1640, 200+30, 180, 20);
			photoTypeTextField = new JTextField();
			photoTypeTextField.setBounds(1750, 200+30, 160, 25);
			photoTypeTextField.setBorder(Constants.LIGHT_GRAY_BORDER);
			photoTypeTextField.setText("42");
			photoTypeTextField.setFont(Constants.BASIC_FONT4);
			photoTypeTextField.setForeground(Color.GRAY); 
			MainPanel.add(photoTypeTextField);
			
			DefinitionJLabel(name,"图片名称",1640, 200+60, 180, 20);
			nameTextField = new JTextField();
			nameTextField.setBounds(1750, 200+60, 160, 25);
			nameTextField.setBorder(Constants.LIGHT_GRAY_BORDER);
			nameTextField.setText("征信授权照片");
			nameTextField.setFont(Constants.BASIC_FONT4);
			nameTextField.setForeground(Color.GRAY); 
			MainPanel.add(nameTextField);
			
			DefinitionJLabel(path,"图片路径",1640, 200+90, 180, 20);
			pathTextField = new JTextField();
			pathTextField.setBounds(1750, 200+90, 160, 25);
			...
			pathTextField.setFont(Constants.BASIC_FONT4);
...
//	    	DefinitionButton(OneManualCredit,730, 850, 160, 30,"一键手动生成合同");
			...
			OneManualCredit.setBounds(1700, 350, 180, 30);
			OneManualCredit.setFont(Constants.BASIC_FONT4);
	    	MainPanel.add(OneManualCredit);
			
			plus = new JLabel("+");
			plus.setBounds(1780, 350+35, 160, 30);
			plus.setFont(Constants.DIALOG_FONT);
			MainPanel.add(plus);
			
//	    	DefinitionButton(OneManualCredit,730, 850, 160, 30,"一键手动生成合同");
	    	OneManualCreditBaseInfo = new JButton("一键保存合同基础信息");
	    	OneManualCreditBaseInfo.setBounds(1700, 420, 180, 30);
	    	OneManualCreditBaseInfo.setFont(Constants.BASIC_FONT4);
	    	MainPanel.add(OneManualCreditBaseInfo);
			
			plus = new JLabel("+");
			plus.setBounds(1780, 420+35, 160, 30);
			plus.setFont(Constants.DIALOG_FONT);
			MainPanel.add(plus);
			
	    	OneManualCreditCompanyInfo = new JButton("一键保存合同单位信息");
	    	OneManualCreditCompanyInfo.setBounds(1700, 490, 180, 30);
	    	OneManualCreditCompanyInfo.setFont(Constants.BASIC_FONT4);
	    	MainPanel.add(OneManualCreditCompanyInfo);
	    	
			plus = new JLabel("+");
			plus.setBounds(1780, 490+35, 160, 30);
			plus.setFont(Constants.DIALOG_FONT);
			MainPanel.add(plus);
			
	    	OneManualCreditLinkInfo = new JButton("一键保存合同联系人信息");
	    	OneManualCreditLinkInfo.setBounds(1700, 560, 180, 30);
	    	OneManualCreditLinkInfo.setFont(Constants.BASIC_FONT4);
	    	MainPanel.add(OneManualCreditLinkInfo);
	    	
			plus = new JLabel("+");
			plus.setBounds(1780, 560+35, 160, 30);
			plus.setFont(Constants.DIALOG_FONT);
			MainPanel.add(plus);
			
	    	OneManualCreditBankInfo = new JButton("一键保存合同银行卡信息");
	    	OneManualCreditBankInfo.setBounds(1700, 630, 180, 30);
	    	OneManualCreditBankInfo.setFont(Constants.BASIC_FONT4);
	    	MainPanel.add(OneManualCreditBankInfo);
	    	
			plus = new JLabel("+");
			plus.setBounds(1780, 630+35, 160, 30);
			plus.setFont(Constants.DIALOG_FONT);
			MainPanel.add(plus);
			
	    	OneManualCreditOtherInfo = new JButton("一键保存合同其他信息");
	    	OneManualCreditOtherInfo.setBounds(1700, 700, 180, 30);
	    	OneManualCreditOtherInfo.setFont(Constants.BASIC_FONT4);
	    	MainPanel.add(OneManualCreditOtherInfo);
	    	
			plus = new JLabel("+");
			plus.setBounds(1780, 700+35, 160, 30);
			plus.setFont(Constants.DIALOG_FONT);
			MainPanel.add(plus);
			
	    	OneManualCreditUploadPhoto = new JButton("一键上传影像证明图片");
	    	OneManualCreditUploadPhoto.setBounds(1700, 770, 180, 30);
	    	OneManualCreditUploadPhoto.setFont(Constants.BASIC_FONT4);
	    	MainPanel.add(OneManualCreditUploadPhoto);
	    	
			plus = new JLabel("=");
			plus.setBounds(1780, 770+35, 160, 30);
			plus.setFont(Constants.DIALOG_FONT);
			MainPanel.add(plus);
			
	    	OneManualCreditSubmit = new JButton("一键提交保存合同");
	    	OneManualCreditSubmit.setBounds(1700, 840, 180, 30);
	    	OneManualCreditSubmit.setFont(Constants.BASIC_FONT4);
	    	MainPanel.add(OneManualCreditSubmit);
	    	
	    	InquiryContractButton = new JButton("切换至查询合同费用界面");
	    	InquiryContractButton.setFont(Constants.BASIC_FONT4);
	    	InquiryContractButton.setBounds(1700, 900, 180, 30);
			MainPanel.add(InquiryContractButton);
			
			HangUpProcessButton = new JButton("挂起进程");
			HangUpProcessButton.setFont(Constants.BASIC_FONT4);
			HangUpProcessButton.setBounds(1790, 950, 90, 30);
	...
	private void initFocusListener() {
		...
		UserIDTextField.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				...
				String UserID = String.valueOf(UserIDTextField.getText());
				if (ApiHandler1_1920x1080.isEmpty(UserID)) {
			...
			public void focusGained(FocusEvent e) {
				...
				String UserID = String.valueOf(UserIDTextField.getText());
				if (ApiHandler1_1920x1080.isEqual(UserID,"请输入用户ID...")) {
		...
		UserPassWordTextField.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				...
				if (ApiHandler1_1920x1080.isEmpty(PassWord)) {
			...
			public void focusGained(FocusEvent e) {
				...
				String PassWord = String.valueOf(UserPassWordTextField.getText());
				if (ApiHandler1_1920x1080.isEqual(PassWord,"请输入用户密码...")) {
		...
		UserBoundStoreTextField.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				...
				if (ApiHandler1_1920x1080.isEmpty(UserBoundStore)) {
			...
			public void focusGained(FocusEvent e) {
				...
				String UserBoundStore = String.valueOf(UserBoundStoreTextField.getText());
				if (ApiHandler1_1920x1080.isEqual(UserBoundStore,"请输入门店序号...")) {
		...
		StoreBoundCommodityTypeTextField.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				...
				if (ApiHandler1_1920x1080.isEmpty(StoreBoundCommodityType)) {
			...
			public void focusGained(FocusEvent e) {
				...
				String StoreBoundCommodityType = String.valueOf(StoreBoundCommodityTypeTextField.getText());
				if (ApiHandler1_1920x1080.isEqual(StoreBoundCommodityType,"请输入商品类型序号...")) {
		...
		StoreBoundProductVersionTextField.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				...
				if (ApiHandler1_1920x1080.isEmpty(StoreBoundProductVersion)) {
			...
			public void focusGained(FocusEvent e) {
				...
				String StoreBoundProductVersion = String.valueOf(StoreBoundProductVersionTextField.getText());
				if (ApiHandler1_1920x1080.isEqual(StoreBoundProductVersion,"请输入产品版本序号...")) {
		...
		StoreBoundProductTypeTextField.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				...
				if (ApiHandler1_1920x1080.isEmpty(StoreBoundProductType)) {
			...
			public void focusGained(FocusEvent e) {
				...
				String StoreBoundProductType = String.valueOf(StoreBoundProductTypeTextField.getText());
				if (ApiHandler1_1920x1080.isEqual(StoreBoundProductType,"请输入产品类型序号...")) {
		...
		ProductInforMationStorIdTextField.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				...
				if (ApiHandler1_1920x1080.isEmpty(ProductInforMationStorId)) {
			...
			public void focusGained(FocusEvent e) {
				...
				String ProductInforMationStorId = String.valueOf(ProductInforMationStorIdTextField.getText());
				if (ApiHandler1_1920x1080.isEqual(ProductInforMationStorId,"请输入商品门店ID...")) {
		...
		ProductInforMationgoodsCategoryIdTextField.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				...
				String ProductInforMationgoodsCategoryId = String.valueOf(ProductInforMationgoodsCategoryIdTextField.getText());
				if (ApiHandler1_1920x1080.isEmpty(ProductInforMationgoodsCategoryId)) {
			...
			public void focusGained(FocusEvent e) {
				...
				String ProductInforMationgoodsCategoryId = String.valueOf(ProductInforMationgoodsCategoryIdTextField.getText());
				if (ApiHandler1_1920x1080.isEqual(ProductInforMationgoodsCategoryId,"请输入商品类型ID...")) {
		...
		ProductInforMationSearchTypeIdTextField.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				...
				String ProductInforMationSearchTypeId = String.valueOf(ProductInforMationSearchTypeIdTextField.getText());
				if (ApiHandler1_1920x1080.isEmpty(ProductInforMationSearchTypeId)) {
			...
			public void focusGained(FocusEvent e) {
				...
				String ProductInforMationSearchTypeId = String.valueOf(ProductInforMationSearchTypeIdTextField.getText());
				if (ApiHandler1_1920x1080.isEqual(ProductInforMationSearchTypeId,"请输入产品版本ID...")) {
		...
		ProductInforMationProductTypeIdTextField.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				...
				String ProductInforMationProductTypeId = String.valueOf(ProductInforMationProductTypeIdTextField.getText());
				if (ApiHandler1_1920x1080.isEmpty(ProductInforMationProductTypeId)) {
			...
			public void focusGained(FocusEvent e) {
				...
				String ProductInforMationProductTypeId = String.valueOf(ProductInforMationProductTypeIdTextField.getText());
				if (ApiHandler1_1920x1080.isEqual(ProductInforMationProductTypeId,"请输入产品类型ID...")) {
		...
		ProductInforMationPriceTextField.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				...
				String ProductInforMationPrice = String.valueOf(ProductInforMationPriceTextField.getText());
				if (ApiHandler1_1920x1080.isEmpty(ProductInforMationPrice)) {
			...
			public void focusGained(FocusEvent e) {
				...
				String ProductInforMationPrice = String.valueOf(ProductInforMationPriceTextField.getText());
				if (ApiHandler1_1920x1080.isEqual(ProductInforMationPrice,"请输入商品总额...")) {
		...
		ProductInforMationFirstPayTextField.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				...
				String ProductInforMationFirstPay = String.valueOf(ProductInforMationFirstPayTextField.getText());
				if (ApiHandler1_1920x1080.isEmpty(ProductInforMationFirstPay)) {
			...
			public void focusGained(FocusEvent e) {
				...
				String ProductInforMationFirstPay = String.valueOf(ProductInforMationFirstPayTextField.getText());
				if (ApiHandler1_1920x1080.isEqual(ProductInforMationFirstPay,"请输入首付总额...")) {
		...
		ProductInforMationIsWalletTextField.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				...
				String ProductInforMationIsWallet = String.valueOf(ProductInforMationIsWalletTextField.getText());
				if (ApiHandler1_1920x1080.isEmpty(ProductInforMationIsWallet)) {
			...
			public void focusGained(FocusEvent e) {
				...
				String ProductInforMationIsWallet = String.valueOf(ProductInforMationIsWalletTextField.getText());
				if (ApiHandler1_1920x1080.isEqual(ProductInforMationIsWallet,"请输入首付比例...")) {
		...
		ProductInforMationTextField.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				...
				if (ApiHandler1_1920x1080.isEmpty(ProductInforMation)) {
			...
			public void focusGained(FocusEvent e) {
				...
				String ProductInforMation = String.valueOf(ProductInforMationTextField.getText());
				if (ApiHandler1_1920x1080.isEqual(ProductInforMation,"请输入分期产品序号...")) {
		...
		TypeBoundGoodsGoodsTypeIdTextField.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				...
				if (ApiHandler1_1920x1080.isEmpty(BrandBoundGoodsGoodsTypeId)) {
			...
			public void focusGained(FocusEvent e) {
				...
				String BrandBoundGoodsGoodsTypeId = String.valueOf(TypeBoundGoodsGoodsTypeIdTextField.getText());
				if (ApiHandler1_1920x1080.isEqual(BrandBoundGoodsGoodsTypeId,"请输入商品类型ID...")) {
		...
		TypeBoundGoodsTextField.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				...
				if (ApiHandler1_1920x1080.isEmpty(BrandBoundGoods)) {
			...
			public void focusGained(FocusEvent e) {
				...
				String BrandBoundGoods = String.valueOf(TypeBoundGoodsTextField.getText());
				if (ApiHandler1_1920x1080.isEqual(BrandBoundGoods,"请输入商品小类序号...")) {
		...
		GoodsBoundBrandsGoodsSubTypeValueTextField.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				...
				if (ApiHandler1_1920x1080.isEmpty(GoodsBoundBrandsGoodsSubTypeValue)) {
			...
			public void focusGained(FocusEvent e) {
				...
				String GoodsBoundBrandsGoodsSubTypeValue = String.valueOf(GoodsBoundBrandsGoodsSubTypeValueTextField.getText());
				if (ApiHandler1_1920x1080.isEqual(GoodsBoundBrandsGoodsSubTypeValue,"请输入商品小类Value...")) {
		...
		GoodsBoundBrandsGoodsTypeIdTextField.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				...
				if (ApiHandler1_1920x1080.isEmpty(GoodsBoundBrandsGoodsTypeId)) {
			...
			public void focusGained(FocusEvent e) {
				...
				String GoodsBoundBrandsGoodsTypeId = String.valueOf(GoodsBoundBrandsGoodsTypeIdTextField.getText());
				if (ApiHandler1_1920x1080.isEqual(GoodsBoundBrandsGoodsTypeId,"请输入商品类型ID...")) {
		...
		GoodsBoundBrandsTextField.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				...
				if (ApiHandler1_1920x1080.isEmpty(GoodsBoundBrands)) {
			...
			public void focusGained(FocusEvent e) {
				...
				String GoodsBoundBrands = String.valueOf(GoodsBoundBrandsTextField.getText());
				if (ApiHandler1_1920x1080.isEqual(GoodsBoundBrands,"请输入商品品牌序号...")) {
...
//				if (ApiHandler1_1920x1080.isEmpty(Model)) {
...
//				
//				String Model = String.valueOf(ModelTextField.getText());
//				if (ApiHandler1_1920x1080.isEqual(Model,"请输入商品型号...")) {
	...
	private void initButtonEvent() {  
		...
		UserInfoButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
					ApiHandler1_1920x1080.UserInfo(UserID,UserPassword);
				} catch (Exception e1) {
					e1.printStackTrace();
				}
			}
		...
		UserBoundStoreButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
					int StoreID=Integer.parseInt(UserBoundStoreTextField.getText());
					String StoreCode = ApiHandler_OneTouchCredit_1920x1080.UserBoundStore(UserID,UserPassword,"data.code["+StoreID+"-2]");
					String StoreName = ApiHandler_OneTouchCredit_1920x1080.UserBoundStore(UserID,UserPassword,"data.name["+StoreID+"-2]");
		            String StoreCode1 = ApiHandler_OneTouchCredit_1920x1080.UserBoundStore(UserID,UserPassword,"data.code["+StoreID+"-1]");
		            String StoreName1 = ApiHandler_OneTouchCredit_1920x1080.UserBoundStore(UserID,UserPassword,"data.name["+StoreID+"-1]");
		            String UserBoundStoreValue = StoreCode+"-"+StoreName;
		            String UserBoundStoreValue1 = StoreCode1+"-"+StoreName1;
		            
		            ApiHandler1_1920x1080.UserBoundStore(UserID,UserPassword);
			    	DefinitionBox(UserBoundStoreBox, 200, 40, 300, 25,StoreID,UserBoundStoreValue,UserBoundStoreValue1,null,null,null,null,null,null,null,null, null, null, null, null, null, null, null, null
					,null,null,null,null,null,null,null,null,null);
				} catch (Exception e1) {
					e1.printStackTrace();
		...
		StoreBoundCommodityTypeButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
			    	...
			    	String CommodityTypeText = ApiHandler_OneTouchCredit_1920x1080.StoreBoundCommodityType(UserID,UserPassword,""+CommodityTypeData+"."+CommodityTypeStores+"",""+CommodityTypeGoodTypes+"["+CommodityID+"].text[0]");
			    	String CommodityTypeText1 = ApiHandler_OneTouchCredit_1920x1080.StoreBoundCommodityType(UserID,UserPassword,""+CommodityTypeData+"."+CommodityTypeStores+"",""+CommodityTypeGoodTypes+"["+CommodityID+"].text[1]");
			    	String CommodityTypeText2 = ApiHandler_OneTouchCredit_1920x1080.StoreBoundCommodityType(UserID,UserPassword,""+CommodityTypeData+"."+CommodityTypeStores+"",""+CommodityTypeGoodTypes+"["+CommodityID+"].text[2]");
			    	String CommodityTypeText3 = ApiHandler_OneTouchCredit_1920x1080.StoreBoundCommodityType(UserID,UserPassword,""+CommodityTypeData+"."+CommodityTypeStores+"",""+CommodityTypeGoodTypes+"["+CommodityID+"].text[3]");
			    	String CommodityTypeText4 = ApiHandler_OneTouchCredit_1920x1080.StoreBoundCommodityType(UserID,UserPassword,""+CommodityTypeData+"."+CommodityTypeStores+"",""+CommodityTypeGoodTypes+"["+CommodityID+"].text[4]");
			    	String CommodityTypeText5 = ApiHandler_OneTouchCredit_1920x1080.StoreBoundCommodityType(UserID,UserPassword,""+CommodityTypeData+"."+CommodityTypeStores+"",""+CommodityTypeGoodTypes+"["+CommodityID+"].text[5]");
			    	String CommodityTypeText6 = ApiHandler_OneTouchCredit_1920x1080.StoreBoundCommodityType(UserID,UserPassword,""+CommodityTypeData+"."+CommodityTypeStores+"",""+CommodityTypeGoodTypes+"["+CommodityID+"].text[6]");
			    	String CommodityTypeText7 = ApiHandler_OneTouchCredit_1920x1080.StoreBoundCommodityType(UserID,UserPassword,""+CommodityTypeData+"."+CommodityTypeStores+"",""+CommodityTypeGoodTypes+"["+CommodityID+"].text[7]");
			    	String CommodityTypeText8 = ApiHandler_OneTouchCredit_1920x1080.StoreBoundCommodityType(UserID,UserPassword,""+CommodityTypeData+"."+CommodityTypeStores+"",""+CommodityTypeGoodTypes+"["+CommodityID+"].text[8]");
			    	String CommodityTypeText9 = ApiHandler_OneTouchCredit_1920x1080.StoreBoundCommodityType(UserID,UserPassword,""+CommodityTypeData+"."+CommodityTypeStores+"",""+CommodityTypeGoodTypes+"["+CommodityID+"].text[9]");
			    	String CommodityTypeText10 = ApiHandler_OneTouchCredit_1920x1080.StoreBoundCommodityType(UserID,UserPassword,""+CommodityTypeData+"."+CommodityTypeStores+"",""+CommodityTypeGoodTypes+"["+CommodityID+"].text[10]");
			    	String CommodityTypeText11 = ApiHandler_OneTouchCredit_1920x1080.StoreBoundCommodityType(UserID,UserPassword,""+CommodityTypeData+"."+CommodityTypeStores+"",""+CommodityTypeGoodTypes+"["+CommodityID+"].text[11]");
			    	String CommodityTypeText12 = ApiHandler_OneTouchCredit_1920x1080.StoreBoundCommodityType(UserID,UserPassword,""+CommodityTypeData+"."+CommodityTypeStores+"",""+CommodityTypeGoodTypes+"["+CommodityID+"].text[12]");
			    	String CommodityTypeText13 = ApiHandler_OneTouchCredit_1920x1080.StoreBoundCommodityType(UserID,UserPassword,""+CommodityTypeData+"."+CommodityTypeStores+"",""+CommodityTypeGoodTypes+"["+CommodityID+"].text[13]");
			    	String CommodityTypeText14 = ApiHandler_OneTouchCredit_1920x1080.StoreBoundCommodityType(UserID,UserPassword,""+CommodityTypeData+"."+CommodityTypeStores+"",""+CommodityTypeGoodTypes+"["+CommodityID+"].text[14]");
			    	String CommodityTypeText15 = ApiHandler_OneTouchCredit_1920x1080.StoreBoundCommodityType(UserID,UserPassword,""+CommodityTypeData+"."+CommodityTypeStores+"",""+CommodityTypeGoodTypes+"["+CommodityID+"].text[15]");
			    	String CommodityTypeText16 = ApiHandler_OneTouchCredit_1920x1080.StoreBoundCommodityType(UserID,UserPassword,""+CommodityTypeData+"."+CommodityTypeStores+"",""+CommodityTypeGoodTypes+"["+CommodityID+"].text[16]");
			    	String CommodityTypeText17 = ApiHandler_OneTouchCredit_1920x1080.StoreBoundCommodityType(UserID,UserPassword,""+CommodityTypeData+"."+CommodityTypeStores+"",""+CommodityTypeGoodTypes+"["+CommodityID+"].text[17]");
			    	
		            DefinitionBox(StoreBoundCommodityTypeBox, 200, 70, 300, 25,CommodityTypeID,CommodityTypeText,CommodityTypeText1,CommodityTypeText2,CommodityTypeText3,CommodityTypeText4,CommodityTypeText5,
				    CommodityTypeText6,CommodityTypeText7,CommodityTypeText8,CommodityTypeText9,CommodityTypeText10,CommodityTypeText11,CommodityTypeText12,CommodityTypeText13,CommodityTypeText14,
				    CommodityTypeText15,CommodityTypeText16,CommodityTypeText17,null,null,null,null,null,null,null,null,null);
		            
					ApiHandler1_1920x1080.StoreBoundCommodityType(UserID,UserPassword);
				} catch (Exception e1) {
					e1.printStackTrace();
				}	    	
		    }
		...
		StoreBoundProductVersionButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
					...
					String ProductVersionText = ApiHandler_OneTouchCredit_1920x1080.StoreBoundProductVersion(UserID,UserPassword,""+ProductVersionData+"."+ProductVersionStores+"",""+ProductVersionProductTypes+"["+BoundStoreID+"].text[0]");
			    	String ProductVersionText1 = ApiHandler_OneTouchCredit_1920x1080.StoreBoundProductVersion(UserID,UserPassword,""+ProductVersionData+"."+ProductVersionStores+"",""+ProductVersionProductTypes+"["+BoundStoreID+"].text[1]");
			    	String ProductVersionText2 = ApiHandler_OneTouchCredit_1920x1080.StoreBoundProductVersion(UserID,UserPassword,""+ProductVersionData+"."+ProductVersionStores+"",""+ProductVersionProductTypes+"["+BoundStoreID+"].text[2]");
			    	String ProductVersionText3 = ApiHandler_OneTouchCredit_1920x1080.StoreBoundProductVersion(UserID,UserPassword,""+ProductVersionData+"."+ProductVersionStores+"",""+ProductVersionProductTypes+"["+BoundStoreID+"].text[3]");
			    	String ProductVersionText4 = ApiHandler_OneTouchCredit_1920x1080.StoreBoundProductVersion(UserID,UserPassword,""+ProductVersionData+"."+ProductVersionStores+"",""+ProductVersionProductTypes+"["+BoundStoreID+"].text[4]");
			    	String ProductVersionText5 = ApiHandler_OneTouchCredit_1920x1080.StoreBoundProductVersion(UserID,UserPassword,""+ProductVersionData+"."+ProductVersionStores+"",""+ProductVersionProductTypes+"["+BoundStoreID+"].text[5]");
			    	String ProductVersionText6 = ApiHandler_OneTouchCredit_1920x1080.StoreBoundProductVersion(UserID,UserPassword,""+ProductVersionData+"."+ProductVersionStores+"",""+ProductVersionProductTypes+"["+BoundStoreID+"].text[6]");
			    	String ProductVersionText7 = ApiHandler_OneTouchCredit_1920x1080.StoreBoundProductVersion(UserID,UserPassword,""+ProductVersionData+"."+ProductVersionStores+"",""+ProductVersionProductTypes+"["+BoundStoreID+"].text[7]");
			    	String ProductVersionText8 = ApiHandler_OneTouchCredit_1920x1080.StoreBoundProductVersion(UserID,UserPassword,""+ProductVersionData+"."+ProductVersionStores+"",""+ProductVersionProductTypes+"["+BoundStoreID+"].text[8]");
			    	String ProductVersionText9 = ApiHandler_OneTouchCredit_1920x1080.StoreBoundProductVersion(UserID,UserPassword,""+ProductVersionData+"."+ProductVersionStores+"",""+ProductVersionProductTypes+"["+BoundStoreID+"].text[9]");
//			    	String ProductVersionText10 = ApiHandler_OneTouchCredit_1920x1081.StoreBoundCommodityType(UserID,UserPassword,""+ProductVersionData+"."+ProductVersionStores+"",""+ProductVersionProductTypes+"["+BoundStoreID+"].text[10]");
//			    	String ProductVersionText11 = ApiHandler_OneTouchCredit_1920x1081.StoreBoundCommodityType(UserID,UserPassword,""+ProductVersionData+"."+ProductVersionStores+"",""+ProductVersionProductTypes+"["+BoundStoreID+"].text[11]");
//			    	String ProductVersionText12 = ApiHandler_OneTouchCredit_1920x1081.StoreBoundCommodityType(UserID,UserPassword,""+ProductVersionData+"."+ProductVersionStores+"",""+ProductVersionProductTypes+"["+BoundStoreID+"].text[12]");
//			    	String ProductVersionText13 = ApiHandler_OneTouchCredit_1920x1081.StoreBoundCommodityType(UserID,UserPassword,""+ProductVersionData+"."+ProductVersionStores+"",""+ProductVersionProductTypes+"["+BoundStoreID+"].text[13]");
...
//			    	String ProductVersionText17 = ApiHandler_OneTouchCredit_1920x1081.StoreBoundCommodityType(UserID,UserPassword,""+ProductVersionData+"."+ProductVersionStores+"",""+ProductVersionProductTypes+"["+BoundStoreID+"].text[17]");
					...
					ApiHandler1_1920x1080.StoreBoundProductVersion(UserID,UserPassword);
				} catch (Exception e1) {
					e1.printStackTrace();
				}	    	
		    }
		...
		StoreBoundProductTypeButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
					...
					String ProductTypeText = ApiHandler_OneTouchCredit_1920x1080.StoreBoundProductType(UserID,UserPassword,""+ProductTypeData+"."+ProductTypetext+"[0]");
//					String ProductTypeText1 = ApiHandler_OneTouchCredit_1920x1081.StoreBoundProductType(UserID,UserPassword,""+ProductTypeData+"."+ProductTypetext+"[1]");

		            DefinitionBox(StoreBoundProductVersionBox, 200, 130, 300, 25,ProductTypeID,ProductTypeText,null,null,null,null,null,
		            		null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null); 
		            
					ApiHandler1_1920x1080.StoreBoundProductType(UserID,UserPassword);
				} catch (Exception e1) {
					e1.printStackTrace();
				}	    	
		    }
...
//					String ProductInforMationIsWallet = String.valueOf(ProductInforMationIsWalletTextField.getText());
					...
					String ProductInforMationPaymentNumText = ApiHandler_OneTouchCredit_1920x1080.ProductInforMation(ProductInforMationStoreId,ProductInforMationGoodsCategoryId,ProductInforMationSearchTypeId,
					       ProductInforMationProductTypeId,ProductInforMationPrice,ProductInforMationFirstPay,ProductInforMationIsWallet,UserID,UserPassword,""+ProductInforMationData+"."+ProductInforMationEntities+"",""+ProductInforMationPaymentNum+"[0]");
					
					String ProductInforMationPaymentText = ApiHandler_OneTouchCredit_1920x1080.ProductInforMation(ProductInforMationStoreId,ProductInforMationGoodsCategoryId,ProductInforMationSearchTypeId,
						   ProductInforMationProductTypeId,ProductInforMationPrice,ProductInforMationFirstPay,ProductInforMationIsWallet,UserID,UserPassword,""+ProductInforMationData+"."+ProductInforMationEntities+"",""+ProductInforMationPayment+"[0]");
					
					String ProductInforMationProdCodeText = ApiHandler_OneTouchCredit_1920x1080.ProductInforMation(ProductInforMationStoreId,ProductInforMationGoodsCategoryId,ProductInforMationSearchTypeId,
					       ProductInforMationProductTypeId,ProductInforMationPrice,ProductInforMationFirstPay,ProductInforMationIsWallet,UserID,UserPassword,""+ProductInforMationData+"."+ProductInforMationEntities+"",""+ProductInforMationProdCode+"[0]");

					String ProductInforMationProdNameText = ApiHandler_OneTouchCredit_1920x1080.ProductInforMation(ProductInforMationStoreId,ProductInforMationGoodsCategoryId,ProductInforMationSearchTypeId,
						   ProductInforMationProductTypeId,ProductInforMationPrice,ProductInforMationFirstPay,ProductInforMationIsWallet,UserID,UserPassword,""+ProductInforMationData+"."+ProductInforMationEntities+"",""+ProductInforMationProdName+"[0]");
					

		            String ProductInforMationPaymentNumText1 = ApiHandler_OneTouchCredit_1920x1080.ProductInforMation(ProductInforMationStoreId,ProductInforMationGoodsCategoryId,ProductInforMationSearchTypeId,
					       ProductInforMationProductTypeId,ProductInforMationPrice,ProductInforMationFirstPay,ProductInforMationIsWallet,UserID,UserPassword,""+ProductInforMationData+"."+ProductInforMationEntities+"",""+ProductInforMationPaymentNum+"[1]");
					
					String ProductInforMationPaymentText1 = ApiHandler_OneTouchCredit_1920x1080.ProductInforMation(ProductInforMationStoreId,ProductInforMationGoodsCategoryId,ProductInforMationSearchTypeId,
						   ProductInforMationProductTypeId,ProductInforMationPrice,ProductInforMationFirstPay,ProductInforMationIsWallet,UserID,UserPassword,""+ProductInforMationData+"."+ProductInforMationEntities+"",""+ProductInforMationPayment+"[1]");
					
					String ProductInforMationProdCodeText1 = ApiHandler_OneTouchCredit_1920x1080.ProductInforMation(ProductInforMationStoreId,ProductInforMationGoodsCategoryId,ProductInforMationSearchTypeId,
					       ProductInforMationProductTypeId,ProductInforMationPrice,ProductInforMationFirstPay,ProductInforMationIsWallet,UserID,UserPassword,""+ProductInforMationData+"."+ProductInforMationEntities+"",""+ProductInforMationProdCode+"[1]");

					String ProductInforMationProdNameText1 = ApiHandler_OneTouchCredit_1920x1080.ProductInforMation(ProductInforMationStoreId,ProductInforMationGoodsCategoryId,ProductInforMationSearchTypeId,
						   ProductInforMationProductTypeId,ProductInforMationPrice,ProductInforMationFirstPay,ProductInforMationIsWallet,UserID,UserPassword,""+ProductInforMationData+"."+ProductInforMationEntities+"",""+ProductInforMationProdName+"[1]");

					String ProductInforMationPaymentNumText2 = ApiHandler_OneTouchCredit_1920x1080.ProductInforMation(ProductInforMationStoreId,ProductInforMationGoodsCategoryId,ProductInforMationSearchTypeId,
						   ProductInforMationProductTypeId,ProductInforMationPrice,ProductInforMationFirstPay,ProductInforMationIsWallet,UserID,UserPassword,""+ProductInforMationData+"."+ProductInforMationEntities+"",""+ProductInforMationPaymentNum+"[2]");
						
					String ProductInforMationPaymentText2 = ApiHandler_OneTouchCredit_1920x1080.ProductInforMation(ProductInforMationStoreId,ProductInforMationGoodsCategoryId,ProductInforMationSearchTypeId,
						   ProductInforMationProductTypeId,ProductInforMationPrice,ProductInforMationFirstPay,ProductInforMationIsWallet,UserID,UserPassword,""+ProductInforMationData+"."+ProductInforMationEntities+"",""+ProductInforMationPayment+"[2]");
						
					String ProductInforMationProdCodeText2 = ApiHandler_OneTouchCredit_1920x1080.ProductInforMation(ProductInforMationStoreId,ProductInforMationGoodsCategoryId,ProductInforMationSearchTypeId,
					       ProductInforMationProductTypeId,ProductInforMationPrice,ProductInforMationFirstPay,ProductInforMationIsWallet,UserID,UserPassword,""+ProductInforMationData+"."+ProductInforMationEntities+"",""+ProductInforMationProdCode+"[2]");

					String ProductInforMationProdNameText2 = ApiHandler_OneTouchCredit_1920x1080.ProductInforMation(ProductInforMationStoreId,ProductInforMationGoodsCategoryId,ProductInforMationSearchTypeId,
						   ProductInforMationProductTypeId,ProductInforMationPrice,ProductInforMationFirstPay,ProductInforMationIsWallet,UserID,UserPassword,""+ProductInforMationData+"."+ProductInforMationEntities+"",""+ProductInforMationProdName+"[2]");
					
					String ProductInforMationPaymentNumText3 = ApiHandler_OneTouchCredit_1920x1080.ProductInforMation(ProductInforMationStoreId,ProductInforMationGoodsCategoryId,ProductInforMationSearchTypeId,
						  ProductInforMationProductTypeId,ProductInforMationPrice,ProductInforMationFirstPay,ProductInforMationIsWallet,UserID,UserPassword,""+ProductInforMationData+"."+ProductInforMationEntities+"",""+ProductInforMationPaymentNum+"[3]");
							
					String ProductInforMationPaymentText3 = ApiHandler_OneTouchCredit_1920x1080.ProductInforMation(ProductInforMationStoreId,ProductInforMationGoodsCategoryId,ProductInforMationSearchTypeId,
						  ProductInforMationProductTypeId,ProductInforMationPrice,ProductInforMationFirstPay,ProductInforMationIsWallet,UserID,UserPassword,""+ProductInforMationData+"."+ProductInforMationEntities+"",""+ProductInforMationPayment+"[3]");
							
					String ProductInforMationProdCodeText3 = ApiHandler_OneTouchCredit_1920x1080.ProductInforMation(ProductInforMationStoreId,ProductInforMationGoodsCategoryId,ProductInforMationSearchTypeId,
						   ProductInforMationProductTypeId,ProductInforMationPrice,ProductInforMationFirstPay,ProductInforMationIsWallet,UserID,UserPassword,""+ProductInforMationData+"."+ProductInforMationEntities+"",""+ProductInforMationProdCode+"[3]");

					String ProductInforMationProdNameText3 = ApiHandler_OneTouchCredit_1920x1080.ProductInforMation(ProductInforMationStoreId,ProductInforMationGoodsCategoryId,ProductInforMationSearchTypeId,
						   ProductInforMationProductTypeId,ProductInforMationPrice,ProductInforMationFirstPay,ProductInforMationIsWallet,UserID,UserPassword,""+ProductInforMationData+"."+ProductInforMationEntities+"",""+ProductInforMationProdName+"[3]");
		   
					String ProductInforMationPaymentNumText4 = ApiHandler_OneTouchCredit_1920x1080.ProductInforMation(ProductInforMationStoreId,ProductInforMationGoodsCategoryId,ProductInforMationSearchTypeId,
						   ProductInforMationProductTypeId,ProductInforMationPrice,ProductInforMationFirstPay,ProductInforMationIsWallet,UserID,UserPassword,""+ProductInforMationData+"."+ProductInforMationEntities+"",""+ProductInforMationPaymentNum+"[4]");
								
					String ProductInforMationPaymentText4 = ApiHandler_OneTouchCredit_1920x1080.ProductInforMation(ProductInforMationStoreId,ProductInforMationGoodsCategoryId,ProductInforMationSearchTypeId,
						   ProductInforMationProductTypeId,ProductInforMationPrice,ProductInforMationFirstPay,ProductInforMationIsWallet,UserID,UserPassword,""+ProductInforMationData+"."+ProductInforMationEntities+"",""+ProductInforMationPayment+"[4]");
								
					String ProductInforMationProdCodeText4 = ApiHandler_OneTouchCredit_1920x1080.ProductInforMation(ProductInforMationStoreId,ProductInforMationGoodsCategoryId,ProductInforMationSearchTypeId,
						   ProductInforMationProductTypeId,ProductInforMationPrice,ProductInforMationFirstPay,ProductInforMationIsWallet,UserID,UserPassword,""+ProductInforMationData+"."+ProductInforMationEntities+"",""+ProductInforMationProdCode+"[4]");

					String ProductInforMationProdNameText4 = ApiHandler_OneTouchCredit_1920x1080.ProductInforMation(ProductInforMationStoreId,ProductInforMationGoodsCategoryId,ProductInforMationSearchTypeId,
						   ProductInforMationProductTypeId,ProductInforMationPrice,ProductInforMationFirstPay,ProductInforMationIsWallet,UserID,UserPassword,""+ProductInforMationData+"."+ProductInforMationEntities+"",""+ProductInforMationProdName+"[4]");
					
					String ProductInforMationPaymentNumText5 = ApiHandler_OneTouchCredit_1920x1080.ProductInforMation(ProductInforMationStoreId,ProductInforMationGoodsCategoryId,ProductInforMationSearchTypeId,
						   ProductInforMationProductTypeId,ProductInforMationPrice,ProductInforMationFirstPay,ProductInforMationIsWallet,UserID,UserPassword,""+ProductInforMationData+"."+ProductInforMationEntities+"",""+ProductInforMationPaymentNum+"[5]");
								
					String ProductInforMationPaymentText5 = ApiHandler_OneTouchCredit_1920x1080.ProductInforMation(ProductInforMationStoreId,ProductInforMationGoodsCategoryId,ProductInforMationSearchTypeId,
						   ProductInforMationProductTypeId,ProductInforMationPrice,ProductInforMationFirstPay,ProductInforMationIsWallet,UserID,UserPassword,""+ProductInforMationData+"."+ProductInforMationEntities+"",""+ProductInforMationPayment+"[5]");
								
					String ProductInforMationProdCodeText5 = ApiHandler_OneTouchCredit_1920x1080.ProductInforMation(ProductInforMationStoreId,ProductInforMationGoodsCategoryId,ProductInforMationSearchTypeId,
						   ProductInforMationProductTypeId,ProductInforMationPrice,ProductInforMationFirstPay,ProductInforMationIsWallet,UserID,UserPassword,""+ProductInforMationData+"."+ProductInforMationEntities+"",""+ProductInforMationProdCode+"[5]");

					String ProductInforMationProdNameText5 = ApiHandler_OneTouchCredit_1920x1080.ProductInforMation(ProductInforMationStoreId,ProductInforMationGoodsCategoryId,ProductInforMationSearchTypeId,
					       ProductInforMationProductTypeId,ProductInforMationPrice,ProductInforMationFirstPay,ProductInforMationIsWallet,UserID,UserPassword,""+ProductInforMationData+"."+ProductInforMationEntities+"",""+ProductInforMationProdName+"[5]");
					...
					ApiHandler1_1920x1080.ProductInforMation(ProductInforMationStoreId,ProductInforMationGoodsCategoryId,ProductInforMationSearchTypeId,ProductInforMationProductTypeId,ProductInforMationPrice,
		...
		TypeBoundGoodsButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
					...
					String TypeBoundGoodsText = ApiHandler_OneTouchCredit_1920x1080.TypeBoundGoods(TypeBoundGoodsTypeId,UserID,UserPassword,""+TypeBoundGoodsData+"."+TypeBoundGoodstext+"[0]");
					String TypeBoundGoodsText1 = ApiHandler_OneTouchCredit_1920x1080.TypeBoundGoods(TypeBoundGoodsTypeId,UserID,UserPassword,""+TypeBoundGoodsData+"."+TypeBoundGoodstext+"[1]");
					String TypeBoundGoodsText2 = ApiHandler_OneTouchCredit_1920x1080.TypeBoundGoods(TypeBoundGoodsTypeId,UserID,UserPassword,""+TypeBoundGoodsData+"."+TypeBoundGoodstext+"[2]");
					String TypeBoundGoodsText3 = ApiHandler_OneTouchCredit_1920x1080.TypeBoundGoods(TypeBoundGoodsTypeId,UserID,UserPassword,""+TypeBoundGoodsData+"."+TypeBoundGoodstext+"[3]");
					String TypeBoundGoodsText4 = ApiHandler_OneTouchCredit_1920x1080.TypeBoundGoods(TypeBoundGoodsTypeId,UserID,UserPassword,""+TypeBoundGoodsData+"."+TypeBoundGoodstext+"[4]");

		            DefinitionBox(TypeBoundGoodsBox, 520, 250, 200, 25,TypeBoundGoodsTypeID,TypeBoundGoodsText,TypeBoundGoodsText1,TypeBoundGoodsText2,TypeBoundGoodsText3,TypeBoundGoodsText4,null,            
		            		null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null);
		            
					ApiHandler1_1920x1080.TypeBoundGoods(TypeBoundGoodsGoodsTypeId,UserID,UserPassword);
				} catch (Exception e1) {
					e1.printStackTrace();
				}	    	
		    }
		...
		GoodsBoundBrandsButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
					...
					String GoodsBoundBrandsText = ApiHandler_OneTouchCredit_1920x1080.GoodsBoundBrands(GoodsSubTypeValue,GoodsCategoryID,UserID,UserPassword,""+GoodsBoundBrandsData+"."+GoodsBoundBrandstext+"[0]");
					String GoodsBoundBrandsText1 = ApiHandler_OneTouchCredit_1920x1080.GoodsBoundBrands(GoodsSubTypeValue,GoodsCategoryID,UserID,UserPassword,""+GoodsBoundBrandsData+"."+GoodsBoundBrandstext+"[1]");
					String GoodsBoundBrandsText2 = ApiHandler_OneTouchCredit_1920x1080.GoodsBoundBrands(GoodsSubTypeValue,GoodsCategoryID,UserID,UserPassword,""+GoodsBoundBrandsData+"."+GoodsBoundBrandstext+"[2]");
					String GoodsBoundBrandsText3 = ApiHandler_OneTouchCredit_1920x1080.GoodsBoundBrands(GoodsSubTypeValue,GoodsCategoryID,UserID,UserPassword,""+GoodsBoundBrandsData+"."+GoodsBoundBrandstext+"[3]");
					String GoodsBoundBrandsText4 = ApiHandler_OneTouchCredit_1920x1080.GoodsBoundBrands(GoodsSubTypeValue,GoodsCategoryID,UserID,UserPassword,""+GoodsBoundBrandsData+"."+GoodsBoundBrandstext+"[4]");
					String GoodsBoundBrandsText5 = ApiHandler_OneTouchCredit_1920x1080.GoodsBoundBrands(GoodsSubTypeValue,GoodsCategoryID,UserID,UserPassword,""+GoodsBoundBrandsData+"."+GoodsBoundBrandstext+"[5]");
					String GoodsBoundBrandsText6 = ApiHandler_OneTouchCredit_1920x1080.GoodsBoundBrands(GoodsSubTypeValue,GoodsCategoryID,UserID,UserPassword,""+GoodsBoundBrandsData+"."+GoodsBoundBrandstext+"[6]");
					String GoodsBoundBrandsText7 = ApiHandler_OneTouchCredit_1920x1080.GoodsBoundBrands(GoodsSubTypeValue,GoodsCategoryID,UserID,UserPassword,""+GoodsBoundBrandsData+"."+GoodsBoundBrandstext+"[7]");
					String GoodsBoundBrandsText8 = ApiHandler_OneTouchCredit_1920x1080.GoodsBoundBrands(GoodsSubTypeValue,GoodsCategoryID,UserID,UserPassword,""+GoodsBoundBrandsData+"."+GoodsBoundBrandstext+"[8]");
					String GoodsBoundBrandsText9 = ApiHandler_OneTouchCredit_1920x1080.GoodsBoundBrands(GoodsSubTypeValue,GoodsCategoryID,UserID,UserPassword,""+GoodsBoundBrandsData+"."+GoodsBoundBrandstext+"[9]");
					String GoodsBoundBrandsText10 = ApiHandler_OneTouchCredit_1920x1080.GoodsBoundBrands(GoodsSubTypeValue,GoodsCategoryID,UserID,UserPassword,""+GoodsBoundBrandsData+"."+GoodsBoundBrandstext+"[10]");
					String GoodsBoundBrandsText11= ApiHandler_OneTouchCredit_1920x1080.GoodsBoundBrands(GoodsSubTypeValue,GoodsCategoryID,UserID,UserPassword,""+GoodsBoundBrandsData+"."+GoodsBoundBrandstext+"[11]");
					String GoodsBoundBrandsText12 = ApiHandler_OneTouchCredit_1920x1080.GoodsBoundBrands(GoodsSubTypeValue,GoodsCategoryID,UserID,UserPassword,""+GoodsBoundBrandsData+"."+GoodsBoundBrandstext+"[12]");
					String GoodsBoundBrandsText13 = ApiHandler_OneTouchCredit_1920x1080.GoodsBoundBrands(GoodsSubTypeValue,GoodsCategoryID,UserID,UserPassword,""+GoodsBoundBrandsData+"."+GoodsBoundBrandstext+"[13]");
					String GoodsBoundBrandsText14 = ApiHandler_OneTouchCredit_1920x1080.GoodsBoundBrands(GoodsSubTypeValue,GoodsCategoryID,UserID,UserPassword,""+GoodsBoundBrandsData+"."+GoodsBoundBrandstext+"[14]");
					String GoodsBoundBrandsText15 = ApiHandler_OneTouchCredit_1920x1080.GoodsBoundBrands(GoodsSubTypeValue,GoodsCategoryID,UserID,UserPassword,""+GoodsBoundBrandsData+"."+GoodsBoundBrandstext+"[15]");
					String GoodsBoundBrandsText16 = ApiHandler_OneTouchCredit_1920x1080.GoodsBoundBrands(GoodsSubTypeValue,GoodsCategoryID,UserID,UserPassword,""+GoodsBoundBrandsData+"."+GoodsBoundBrandstext+"[16]");
					String GoodsBoundBrandsText17 = ApiHandler_OneTouchCredit_1920x1080.GoodsBoundBrands(GoodsSubTypeValue,GoodsCategoryID,UserID,UserPassword,""+GoodsBoundBrandsData+"."+GoodsBoundBrandstext+"[17]");
					String GoodsBoundBrandsText18 = ApiHandler_OneTouchCredit_1920x1080.GoodsBoundBrands(GoodsSubTypeValue,GoodsCategoryID,UserID,UserPassword,""+GoodsBoundBrandsData+"."+GoodsBoundBrandstext+"[18]");
					String GoodsBoundBrandsText19 = ApiHandler_OneTouchCredit_1920x1080.GoodsBoundBrands(GoodsSubTypeValue,GoodsCategoryID,UserID,UserPassword,""+GoodsBoundBrandsData+"."+GoodsBoundBrandstext+"[19]");
					String GoodsBoundBrandsText20 = ApiHandler_OneTouchCredit_1920x1080.GoodsBoundBrands(GoodsSubTypeValue,GoodsCategoryID,UserID,UserPassword,""+GoodsBoundBrandsData+"."+GoodsBoundBrandstext+"[20]");
					String GoodsBoundBrandsText21 = ApiHandler_OneTouchCredit_1920x1080.GoodsBoundBrands(GoodsSubTypeValue,GoodsCategoryID,UserID,UserPassword,""+GoodsBoundBrandsData+"."+GoodsBoundBrandstext+"[21]");
					String GoodsBoundBrandsText22 = ApiHandler_OneTouchCredit_1920x1080.GoodsBoundBrands(GoodsSubTypeValue,GoodsCategoryID,UserID,UserPassword,""+GoodsBoundBrandsData+"."+GoodsBoundBrandstext+"[22]");
					String GoodsBoundBrandsText23 = ApiHandler_OneTouchCredit_1920x1080.GoodsBoundBrands(GoodsSubTypeValue,GoodsCategoryID,UserID,UserPassword,""+GoodsBoundBrandsData+"."+GoodsBoundBrandstext+"[23]");
					String GoodsBoundBrandsText24 = ApiHandler_OneTouchCredit_1920x1080.GoodsBoundBrands(GoodsSubTypeValue,GoodsCategoryID,UserID,UserPassword,""+GoodsBoundBrandsData+"."+GoodsBoundBrandstext+"[24]");
					String GoodsBoundBrandsText25 = ApiHandler_OneTouchCredit_1920x1080.GoodsBoundBrands(GoodsSubTypeValue,GoodsCategoryID,UserID,UserPassword,""+GoodsBoundBrandsData+"."+GoodsBoundBrandstext+"[25]");
					String GoodsBoundBrandsText26 = ApiHandler_OneTouchCredit_1920x1080.GoodsBoundBrands(GoodsSubTypeValue,GoodsCategoryID,UserID,UserPassword,""+GoodsBoundBrandsData+"."+GoodsBoundBrandstext+"[26]");			
...
//					MainPanel.add(GoodsBoundBrandsBox);
					...
					ApiHandler1_1920x1080.GoodsBoundBrands(GoodsBoundBrandsGoodsSubTypeValue,GoodsBoundBrandsGoodsTypeId,UserID,UserPassword);
				} catch (Exception e1) {
					e1.printStackTrace();
				}	    	
		    }
...
//				}
				...
				try {
					String ID_PERSON = DataBaseHandler1_1920x1080.GetValue(DataVersion,userName);
					DataBaseHandler1_1920x1080.UpdateContractStateButton(DataVersion,ID_PERSON);
					...
					String brand = ApiHandler_OneTouchCredit_1920x1080.GoodsBoundBrands(GoodsSubTypeValue,GoodsCategoryID,UserID,UserPassword,""+GoodsBoundBrandsData+"."+GoodsBoundBrandstext+"["+GoodsBoundBrandsGoodsID+"]");
					...
					String productCode = ApiHandler_OneTouchCredit_1920x1080.ProductInforMation(ProductInforMationStoreId,ProductInforMationGoodsCategoryId,ProductInforMationSearchTypeId,
					...
					ApiHandler1_1920x1080.OneManualCredit(
...
//					}
					...
					String creditId =ApiHandler_OneTouchCredit_1920x1080.OneManualCredit(
					brand,healthFee,model,price,secureFee,selfPay,subTypeId,comprehensiveInsuranceFee,information,goodsLocationNumber,isCarryWifi,
					identAddress,province,city,region,identAuth,goodsTypeId,identExp,identNo,identPhoneBack,identPhoneFront,isStudent,nationalId,price,productCode,productVersionId,productsTypeId,selfPay,sellerPlaceId,userName,powerFlag,powerFee,insuranceFee,insuranceFlag,shoppingCouponsFee,treasureChestFlag,treasureChestFee,
				   ...
				   if("请输入是否学生产品...".equals(isStudent)){
					...
					ApiHandler1_1920x1080.OneManualCreditBaseInfo(
...
//					}
				   ...
				   ApiHandler1_1920x1080.OneManualCreditCompanyInfo(
...
//					}
				   ...
				   ApiHandler1_1920x1080.OneManualCreditLinkInfo(creditId,type,linkerName,phone,relationTypeID,UserID,UserPassword);
				   ApiHandler1_1920x1080.OneManualCreditLinkInfo(creditId,type+1,"时夏","13999999999","5"+relationTypeID,UserID,UserPassword);
				} catch (Exception e1) {
					e1.printStackTrace();
				}	
		    }
...
//					}
				   ...
				   ApiHandler1_1920x1080.OneManualCreditBankInfo(bankAccountNo,bankCity,bankId,bankPhoto,bankProvince,creditId,branch,UserID,UserPassword);
				} catch (Exception e1) {
					e1.printStackTrace();
				}	
		    }
...
//					}
				    ...
				    ApiHandler1_1920x1080.OneManualCreditOtherInfo(creditId,innerCode,remark,shop,isShop,UserID,UserPassword);
                } catch (Exception e1) {
					e1.printStackTrace();
				}	
		    }
...
//					}
				   ...
				   ApiHandler1_1920x1080.OneManualCreditUploadPhoto(creditId,flowType,name,path,photoType,UserID,UserPassword);
				   ApiHandler1_1920x1080.OneManualCreditUploadPhoto(creditId,flowType,"客户门店照片",path,"2",UserID,UserPassword);
				   ApiHandler1_1920x1080.OneManualCreditUploadPhoto(creditId,flowType,"银行卡",path,"15",UserID,UserPassword);
			    } catch (Exception e1) {
					e1.printStackTrace();
				}	
		    }
...
//					}
					...
					//--------------------------------------------------------------------------------------
				    ApiHandler1_1920x1080.OneManualCreditSubmit(creditId,UserID,UserPassword);
	...
	private void Querycontrac() {
		...
		InquiryContract1_1920x1080.getInstance();
	}
...
//		  }
	...
	public static Component DefinitionTextField(JTextField TextField,int x,int y,int l,int w,String Value){ 
    	...
    	TextField.setFont(Constants.BASIC_FONT4);
	...
	public static void DefinitionTextFieldFocusAdapter(JTextField TextField,String Value){ 
		...
		TextField.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				...
				if (ApiHandler1_1920x1080.isEmpty(Text)) {
					TextField.setText(Value);
					TextField.setBorder(Constants.LIGHT_GRAY_BORDER);
				}	
			}
			...
			public void focusGained(FocusEvent e) {
				...
				String Text = String.valueOf(TextField.getText());
				if (ApiHandler1_1920x1080.isEqual(Text,Value)) {
					TextField.setText("");
	...
	public static Component DefinitionButton(JButton Button,int x,int y,int l,int w,String Value){ 
    	...
    	Button.setFont(Constants.BASIC_FONT4);
...
//    	UserBoundStoreBox1.setBounds(160, 40, 180, 25);
