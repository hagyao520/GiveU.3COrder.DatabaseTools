...
public class InquiryContract_1600x900  extends JFrame{
	...
	public static InquiryContract_1600x900 getInstance() {
		InquiryContract_1600x900 inst = new InquiryContract_1600x900();
		inst.setLocationRelativeTo(null);
		inst.setVisible(true);
		return inst;
	}
	
	public InquiryContract_1600x900() {
		super();
		initGUI();
		initTrayIcon();
		initFocusListener();
...
//				if (DataBaseHandler_1600x900.isEmpty(contract_no)) {
...
//		});
		...
		SQLArea.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				...
				if (DataBaseHandler_1600x900.isEmpty(SQL)) {
					SQLArea.setText("请输入SQL...");
				}
			}
			@Override
			public void focusGained(FocusEvent e) {
				...
				String SQL = String.valueOf(SQLArea.getText());
				if (DataBaseHandler_1600x900.isEqual(SQL,"请输入SQL...")) 
					SQLArea.setText("");
	...
	private void initButtonEvent() {  
		...
		UserInfoButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (DataBaseHandler_1600x900.UserIDcompare(DataVersion,User_ID)) {
					JOptionPane.showMessageDialog(null,"查询成功！");
					DataBaseHandler_1600x900.UserInfoButton(DataVersion,User_ID);
				}
		    }
		});
...
//		});		
		...
		CityBoundContractModeButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				DataBaseHandler_1600x900.CityBoundContractModeButton(DataVersion,city);
		    }
		});
...
//		});		
		...
		StoreBoundProductVersionButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				DataBaseHandler_1600x900.StoreBoundProductVersionButton(DataVersion,POS_CODE);
		    }
		});			
		...
		ProductVersionButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				DataBaseHandler_1600x900.ProductVersionButton(DataVersion,REG_VAL_CODE,REG_NUMBER);
		    }
		});			
		...
		ProductInformationButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				DataBaseHandler_1600x900.ProductInformationButton(DataVersion,credit_model,GOODS_CA_ID,search_type,prod_type,INIT_PAY,STATUS);
		    }
		});			
		...
		InsuranceFeeButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				DataBaseHandler_1600x900.InsuranceFeeButton(DataVersion,LoanPrincipal,InsuranceRate,ProductVersionCode);
		    }
		});		
		...
		TreasureBoxFeeButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				DataBaseHandler_1600x900.TreasureBoxFeeButton(DataVersion,LoanPrincipal,TreasureBoxRate,ProductVersionCode);
		    }
		});			
		...
		MallCouponsFeeButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				DataBaseHandler_1600x900.MallCouponsFeeButton(DataVersion,LoanPrincipal,MallCouponsRate,ProductVersionCode);
		    }
		});				
		...
		EachPeriodShouldBeReturnedFeeButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				DataBaseHandler_1600x900.EachPeriodShouldBeReturnedFeeButton(DataVersion,LoanPrincipal,InsuranceFee,TreasureBoxFee,ProductVersionCode);
		    }
		});			
...
//					return;
//				}
				DataBaseHandler_1600x900.EducationalLevelButton(DataVersion,null);
		    }
		});		
...
//					return;
//				}
				DataBaseHandler_1600x900.HousingSituationButton(DataVersion,null);
		    }
		});			
...
//					return;
//				}
				DataBaseHandler_1600x900.MaritalStatusButton(DataVersion,null);
		    }
		});			
...
//					return;
//				}
				DataBaseHandler_1600x900.IndustryCategoryButton(DataVersion,null);
		    }
		});		
...
//					return;
//				}
				DataBaseHandler_1600x900.UnitPropertiesButton(DataVersion,null);
		    }
		});			
...
//					return;
//				}
				DataBaseHandler_1600x900.PositionButton(DataVersion,null);
		    }
		});		
...
//					return;
//				}
				DataBaseHandler_1600x900.WorkingLifeButton(DataVersion,null);
		    }
		});			
...
//		});			
		...
		SMSAuthorizationAuthenticationCodeButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				DataBaseHandler_1600x900.SMSAuthorizationAuthenticationCodeButton(DataVersion,mobile);
		    }
		});		
		...
		CustomerContractButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				DataBaseHandler_1600x900.CustomerContractButton(DataVersion,ID_SA);
		    }
		});			
		...
		RepaymentsForEachPeriodFeeButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				DataBaseHandler_1600x900.RepaymentsForEachPeriodFeeButton(DataVersion,LoanPrincipal,InsuranceFee,TreasureBoxFee,ComprehensiveInsuranceFee,ProductVersionCode);
		    }
		});			
		...
		MonthlyReturnFeeButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				DataBaseHandler_1600x900.MonthlyReturnFeeButton(DataVersion,LoanPrincipal,ProductVersionCode);
		    }
		});			
		...
		MonthlyWeShouldAlsoPrincipalFeeButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				DataBaseHandler_1600x900.MonthlyWeShouldAlsoPrincipalFeeButton(DataVersion,ContractNumber);
		    }
		});		
		...
		MonthlyPayableFeeButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				DataBaseHandler_1600x900.MonthlyPayableFeeButton(DataVersion,ContractNumber);
		    }
		});		
		...
		MonthlyConsultingFeeAndRateButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				DataBaseHandler_1600x900.MonthlyConsultingFeeAndRateButton(DataVersion,ContractNumber);
		    }
		});		
		...
		MonthlyServiceFeeAndRateButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				DataBaseHandler_1600x900.MonthlyServiceFeeAndRateButton(DataVersion,ContractNumber);
		    }
		});			
		...
		MonthlyLoanInterestRateButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				DataBaseHandler_1600x900.MonthlyLoanInterestRateButton(DataVersion,ContractNumber);
		    }
		});		
		...
		ContractStateUpdateButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				DataBaseHandler_1600x900.ContractStateUpdateButton(DataVersion,ContractNumber,ContractState);
		    }
		});		
		...
		ShortMessageSignatureCodeButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				DataBaseHandler_1600x900.ShortMessageSignatureCodeButton(DataVersion,mobile);
		    }
		});		
		...
		PDFSigningContractButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				DataBaseHandler_1600x900.PDFSigningContractButton(DataVersion,ContractNumber);
		    }
		});		
		...
		SignatureRecordDeleteButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
					DataBaseHandler_1600x900.SignatureRecordDeleteButton(DataVersion,ContractID,ContractNumber);
		...
		StoredProcedureExecutionButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				DataBaseHandler_1600x900.StoredProcedureExecutionButton(DataVersion,StoredProcedureName,ContractNumber,ContractID);
		    }
		});			
		...
		ReimbursementPlanQueryButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				DataBaseHandler_1600x900.ReimbursementPlanQueryButton(DataVersion,ContractID);
		    }
		});			
		...
		ReimbursementPlanDeleteButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
					DataBaseHandler_1600x900.ReimbursementPlanDeleteButton(DataVersion,ContractID);
				} catch (SQLException e1) {
					e1.printStackTrace();
				}
		    }
		...
		InquiryContractExpensesButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (DataBaseHandler_1600x900.contractcompare(DataVersion,contract_no)) {
					JOptionPane.showMessageDialog(null,"查询成功！");
				}
				DataBaseHandler_1600x900.InquiryContractExpensesButton(DataVersion,contract_no);
		    }
		});	
		...
		SQLButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (DataBaseHandler_1600x900.isEmpty1(Sql)) {
					JOptionPane.showMessageDialog(null,"查询成功！");
				}
		        DataBaseHandler_1600x900.SQLButton(DataVersion,Sql);
		    }
		});	
	...
	public static void DefinitionTextFieldFocusAdapter(JTextField TextField,String Value){ 
		...
		TextField.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				...
				if (DataBaseHandler_1600x900.isEmpty(Text)) {
			...
			public void focusGained(FocusEvent e) {
				...
				String Text = String.valueOf(TextField.getText());
				if (DataBaseHandler_1600x900.isEqual(Text,Value)) {
					TextField.setText("");
