...
import databasetools.handler_1600x900.ApiHandler1_1600x900;
...
public class OneTouchCredit1_1600x900 extends JFrame{
...
//	private JTextField Other_relationTypeIDTextField;
	...
	public static OneTouchCredit1_1600x900 getInstance() {
		OneTouchCredit1_1600x900 inst = new OneTouchCredit1_1600x900();
		inst.setLocationRelativeTo(null);
		inst.setVisible(true);
		return inst;
	}
	
	public OneTouchCredit1_1600x900() {
		super();
		initGUI();
		initFocusListener();
		initButtonEvent();
	...
	private void initFocusListener() {
		...
		UserIDTextField.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				...
				String UserID = String.valueOf(UserIDTextField.getText());
				if (ApiHandler1_1600x900.isEmpty(UserID)) {
			...
			public void focusGained(FocusEvent e) {
				...
				String UserID = String.valueOf(UserIDTextField.getText());
				if (ApiHandler1_1600x900.isEqual(UserID,"请输入用户ID...")) {
		...
		UserPassWordTextField.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				...
				if (ApiHandler1_1600x900.isEmpty(PassWord)) {
			...
			public void focusGained(FocusEvent e) {
				...
				String PassWord = String.valueOf(UserPassWordTextField.getText());
				if (ApiHandler1_1600x900.isEqual(PassWord,"请输入用户密码...")) {
		...
		UserBoundStoreTextField.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				...
				if (ApiHandler1_1600x900.isEmpty(UserBoundStore)) {
			...
			public void focusGained(FocusEvent e) {
				...
				String UserBoundStore = String.valueOf(UserBoundStoreTextField.getText());
				if (ApiHandler1_1600x900.isEqual(UserBoundStore,"请输入门店序号...")) {
		...
		StoreBoundCommodityTypeTextField.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				...
				if (ApiHandler1_1600x900.isEmpty(StoreBoundCommodityType)) {
			...
			public void focusGained(FocusEvent e) {
				...
				String StoreBoundCommodityType = String.valueOf(StoreBoundCommodityTypeTextField.getText());
				if (ApiHandler1_1600x900.isEqual(StoreBoundCommodityType,"请输入商品类型序号...")) {
		...
		StoreBoundProductVersionTextField.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				...
				if (ApiHandler1_1600x900.isEmpty(StoreBoundProductVersion)) {
			...
			public void focusGained(FocusEvent e) {
				...
				String StoreBoundProductVersion = String.valueOf(StoreBoundProductVersionTextField.getText());
				if (ApiHandler1_1600x900.isEqual(StoreBoundProductVersion,"请输入产品版本序号...")) {
		...
		StoreBoundProductTypeTextField.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				...
				if (ApiHandler1_1600x900.isEmpty(StoreBoundProductType)) {
			...
			public void focusGained(FocusEvent e) {
				...
				String StoreBoundProductType = String.valueOf(StoreBoundProductTypeTextField.getText());
				if (ApiHandler1_1600x900.isEqual(StoreBoundProductType,"请输入产品类型序号...")) {
		...
		ProductInforMationStorIdTextField.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				...
				if (ApiHandler1_1600x900.isEmpty(ProductInforMationStorId)) {
			...
			public void focusGained(FocusEvent e) {
				...
				String ProductInforMationStorId = String.valueOf(ProductInforMationStorIdTextField.getText());
				if (ApiHandler1_1600x900.isEqual(ProductInforMationStorId,"请输入商品门店ID...")) {
		...
		ProductInforMationgoodsCategoryIdTextField.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				...
				String ProductInforMationgoodsCategoryId = String.valueOf(ProductInforMationgoodsCategoryIdTextField.getText());
				if (ApiHandler1_1600x900.isEmpty(ProductInforMationgoodsCategoryId)) {
			...
			public void focusGained(FocusEvent e) {
				...
				String ProductInforMationgoodsCategoryId = String.valueOf(ProductInforMationgoodsCategoryIdTextField.getText());
				if (ApiHandler1_1600x900.isEqual(ProductInforMationgoodsCategoryId,"请输入商品类型ID...")) {
		...
		ProductInforMationSearchTypeIdTextField.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				...
				String ProductInforMationSearchTypeId = String.valueOf(ProductInforMationSearchTypeIdTextField.getText());
				if (ApiHandler1_1600x900.isEmpty(ProductInforMationSearchTypeId)) {
			...
			public void focusGained(FocusEvent e) {
				...
				String ProductInforMationSearchTypeId = String.valueOf(ProductInforMationSearchTypeIdTextField.getText());
				if (ApiHandler1_1600x900.isEqual(ProductInforMationSearchTypeId,"请输入产品版本ID...")) {
		...
		ProductInforMationProductTypeIdTextField.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				...
				String ProductInforMationProductTypeId = String.valueOf(ProductInforMationProductTypeIdTextField.getText());
				if (ApiHandler1_1600x900.isEmpty(ProductInforMationProductTypeId)) {
			...
			public void focusGained(FocusEvent e) {
				...
				String ProductInforMationProductTypeId = String.valueOf(ProductInforMationProductTypeIdTextField.getText());
				if (ApiHandler1_1600x900.isEqual(ProductInforMationProductTypeId,"请输入产品类型ID...")) {
		...
		ProductInforMationPriceTextField.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				...
				String ProductInforMationPrice = String.valueOf(ProductInforMationPriceTextField.getText());
				if (ApiHandler1_1600x900.isEmpty(ProductInforMationPrice)) {
			...
			public void focusGained(FocusEvent e) {
				...
				String ProductInforMationPrice = String.valueOf(ProductInforMationPriceTextField.getText());
				if (ApiHandler1_1600x900.isEqual(ProductInforMationPrice,"请输入商品总额...")) {
		...
		ProductInforMationFirstPayTextField.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				...
				String ProductInforMationFirstPay = String.valueOf(ProductInforMationFirstPayTextField.getText());
				if (ApiHandler1_1600x900.isEmpty(ProductInforMationFirstPay)) {
			...
			public void focusGained(FocusEvent e) {
				...
				String ProductInforMationFirstPay = String.valueOf(ProductInforMationFirstPayTextField.getText());
				if (ApiHandler1_1600x900.isEqual(ProductInforMationFirstPay,"请输入首付总额...")) {
		...
		ProductInforMationIsWalletTextField.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				...
				String ProductInforMationIsWallet = String.valueOf(ProductInforMationIsWalletTextField.getText());
				if (ApiHandler1_1600x900.isEmpty(ProductInforMationIsWallet)) {
			...
			public void focusGained(FocusEvent e) {
				...
				String ProductInforMationIsWallet = String.valueOf(ProductInforMationIsWalletTextField.getText());
				if (ApiHandler1_1600x900.isEqual(ProductInforMationIsWallet,"请输入首付比例...")) {
		...
		ProductInforMationTextField.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				...
				if (ApiHandler1_1600x900.isEmpty(ProductInforMation)) {
			...
			public void focusGained(FocusEvent e) {
				...
				String ProductInforMation = String.valueOf(ProductInforMationTextField.getText());
				if (ApiHandler1_1600x900.isEqual(ProductInforMation,"请输入分期产品序号...")) {
		...
		TypeBoundGoodsGoodsTypeIdTextField.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				...
				if (ApiHandler1_1600x900.isEmpty(BrandBoundGoodsGoodsTypeId)) {
			...
			public void focusGained(FocusEvent e) {
				...
				String BrandBoundGoodsGoodsTypeId = String.valueOf(TypeBoundGoodsGoodsTypeIdTextField.getText());
				if (ApiHandler1_1600x900.isEqual(BrandBoundGoodsGoodsTypeId,"请输入商品类型ID...")) {
		...
		TypeBoundGoodsTextField.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				...
				if (ApiHandler1_1600x900.isEmpty(BrandBoundGoods)) {
			...
			public void focusGained(FocusEvent e) {
				...
				String BrandBoundGoods = String.valueOf(TypeBoundGoodsTextField.getText());
				if (ApiHandler1_1600x900.isEqual(BrandBoundGoods,"请输入商品小类序号...")) {
		...
		GoodsBoundBrandsGoodsSubTypeValueTextField.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				...
				if (ApiHandler1_1600x900.isEmpty(GoodsBoundBrandsGoodsSubTypeValue)) {
			...
			public void focusGained(FocusEvent e) {
				...
				String GoodsBoundBrandsGoodsSubTypeValue = String.valueOf(GoodsBoundBrandsGoodsSubTypeValueTextField.getText());
				if (ApiHandler1_1600x900.isEqual(GoodsBoundBrandsGoodsSubTypeValue,"请输入商品小类Value...")) {
		...
		GoodsBoundBrandsGoodsTypeIdTextField.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				...
				if (ApiHandler1_1600x900.isEmpty(GoodsBoundBrandsGoodsTypeId)) {
			...
			public void focusGained(FocusEvent e) {
				...
				String GoodsBoundBrandsGoodsTypeId = String.valueOf(GoodsBoundBrandsGoodsTypeIdTextField.getText());
				if (ApiHandler1_1600x900.isEqual(GoodsBoundBrandsGoodsTypeId,"请输入商品类型ID...")) {
		...
		GoodsBoundBrandsTextField.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				...
				if (ApiHandler1_1600x900.isEmpty(GoodsBoundBrands)) {
			...
			public void focusGained(FocusEvent e) {
				...
				String GoodsBoundBrands = String.valueOf(GoodsBoundBrandsTextField.getText());
				if (ApiHandler1_1600x900.isEqual(GoodsBoundBrands,"请输入商品品牌序号...")) {
	...
	private void initButtonEvent() {  
		...
		UserInfoButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
					ApiHandler1_1600x900.UserInfo(UserID,UserPassword);
				} catch (Exception e1) {
					e1.printStackTrace();
				}
			}
		...
		UserBoundStoreButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
		            ...
		            ApiHandler1_1600x900.UserBoundStore(UserID,UserPassword);
		...
		StoreBoundCommodityTypeButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
					...
					ApiHandler1_1600x900.StoreBoundCommodityType(UserID,UserPassword);
				} catch (Exception e1) {
					e1.printStackTrace();
				}	    	
		    }
...
//			    	String ProductVersionText17 = ApiHandler_OneTouchCredit_1920x1081.StoreBoundCommodityType(UserID,UserPassword,""+ProductVersionData+"."+ProductVersionStores+"",""+ProductVersionProductTypes+"["+BoundStoreID+"].text[17]");
					...
					ApiHandler1_1600x900.StoreBoundProductVersion(UserID,UserPassword);
				} catch (Exception e1) {
					e1.printStackTrace();
				}	    	
		    }
...
//					String ProductTypeText1 = ApiHandler_OneTouchCredit_1920x1081.StoreBoundProductType(UserID,UserPassword,""+ProductTypeData+"."+ProductTypetext+"[1]");
					...
					ApiHandler1_1600x900.StoreBoundProductType(UserID,UserPassword);
				} catch (Exception e1) {
					e1.printStackTrace();
				}	    	
		    }
...
//					String ProductInforMationIsWallet = String.valueOf(ProductInforMationIsWalletTextField.getText());
					...
					ApiHandler1_1600x900.ProductInforMation(ProductInforMationStoreId,ProductInforMationGoodsCategoryId,ProductInforMationSearchTypeId,ProductInforMationProductTypeId,ProductInforMationPrice,
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
		          ...
		          DefinitionBox(TypeBoundGoodsBox, 457, 225, 150, 21,TypeBoundGoodsTypeID,TypeBoundGoodsText,TypeBoundGoodsText1,TypeBoundGoodsText2,TypeBoundGoodsText3,TypeBoundGoodsText4,null,            
					...
					ApiHandler1_1600x900.TypeBoundGoods(TypeBoundGoodsGoodsTypeId,UserID,UserPassword);
				} catch (Exception e1) {
					e1.printStackTrace();
				}	    	
		    }
...
//					MainPanel.add(GoodsBoundBrandsBox);
					...
					ApiHandler1_1600x900.GoodsBoundBrands(GoodsBoundBrandsGoodsSubTypeValue,GoodsBoundBrandsGoodsTypeId,UserID,UserPassword);
				} catch (Exception e1) {
					e1.printStackTrace();
				}	    	
		    }
...
//				}
				...
				try {
					String ID_PERSON = DataBaseHandler1_1600x900.GetValue(DataVersion,userName);
					DataBaseHandler1_1600x900.UpdateContractStateButton(DataVersion,ID_PERSON);
					...
					ApiHandler1_1600x900.OneManualCredit(
...
//					}
				   ...
				   if("请输入是否学生产品...".equals(isStudent)){
					...
					ApiHandler1_1600x900.OneManualCreditBaseInfo(
...
//					}
				   ...
				   ApiHandler1_1600x900.OneManualCreditCompanyInfo(
...
//					}
				   ...
				   ApiHandler1_1600x900.OneManualCreditLinkInfo(creditId,type,linkerName,phone,relationTypeID,UserID,UserPassword);
				   ApiHandler1_1600x900.OneManualCreditLinkInfo(creditId,type+1,"时夏","13999999999","5"+relationTypeID,UserID,UserPassword);
				} catch (Exception e1) {
					e1.printStackTrace();
				}	
		    }
...
//					}
				   ...
				   ApiHandler1_1600x900.OneManualCreditBankInfo(bankAccountNo,bankCity,bankId,bankPhoto,bankProvince,creditId,branch,UserID,UserPassword);
				} catch (Exception e1) {
					e1.printStackTrace();
				}	
		    }
...
//					}
				    ...
				    ApiHandler1_1600x900.OneManualCreditOtherInfo(creditId,innerCode,remark,shop,isShop,UserID,UserPassword);
  			    } catch (Exception e1) {
					e1.printStackTrace();
				}	
		    }
...
//					}
				   ...
				   ApiHandler1_1600x900.OneManualCreditUploadPhoto(creditId,flowType,name,path,photoType,UserID,UserPassword);
				   ApiHandler1_1600x900.OneManualCreditUploadPhoto(creditId,flowType,"客户门店照片",path,"2",UserID,UserPassword);
				   ApiHandler1_1600x900.OneManualCreditUploadPhoto(creditId,flowType,"银行卡",path,"15",UserID,UserPassword);
			    } catch (Exception e1) {
					e1.printStackTrace();
				}	
		    }
...
//					}
					...
					//--------------------------------------------------------------------------------------
				    ApiHandler1_1600x900.OneManualCreditSubmit(creditId,UserID,UserPassword);
	...
	public static void DefinitionTextFieldFocusAdapter(JTextField TextField,String Value){ 
		...
		TextField.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				...
				if (ApiHandler1_1600x900.isEmpty(Text)) {
					TextField.setText(Value);
					TextField.setBorder(Constants.LIGHT_GRAY_BORDER);
				}	
			}
			...
			public void focusGained(FocusEvent e) {
				...
				String Text = String.valueOf(TextField.getText());
				if (ApiHandler1_1600x900.isEqual(Text,Value)) {
					TextField.setText("");
