...
import databasetools.handler_1600x900.DataBaseHandler1_1600x900;
import databasetools.ui.common.MyScrollBarUI;
import databasetools.util.*;

@SuppressWarnings("serial")
public class InquiryContract1_1600x900  extends JFrame{
	...
	/** 返回至一键生成合同按钮 */
	private JButton OneTouchCreditButton;
	
	/** 挂起进程按钮 */
	private JButton HangUpProcessButton;

	public static InquiryContract1_1600x900 getInstance() {
		InquiryContract1_1600x900 inst = new InquiryContract1_1600x900();
		inst.setLocationRelativeTo(null);
		inst.setVisible(true);
		return inst;
	}
	
	public InquiryContract1_1600x900() {
		super();
		initGUI();
		initFocusListener();
		initButtonEvent();
...
//			MainPanel.add(UserInfoButton);
			...
			UserInfoTextField.setText("666666");
			...
			UserBoundStoreTextField.setText("666666");
			...
			CityBoundContractModeTextField.setText("达州");
			...
			StoreBoundCommodityTypeTextField.setText("51170000246");
			...
			StoreBoundProductVersionTextField.setText("51170000246");
			...
			ProductVersionCodeTextField.setText("'19','14','15','33','34','35','36','37','21','29','83','85','40','41','42','77','1','24','38'");
			...
			ProductRegistrationCodeTextField.setText("891");
			...
			ContractModeTextField.setText("P2P_TBJ");
			...
			CommodityTypeTextField.setText("7");
			...
			ProductVersionTextField.setText("34");
			...
			ProductTypeTextField.setText("2");
			...
			DownPaymentRatioTextField.setText("10");
			...
			ProductStatusTextField.setText("1");
			...
			LoanPrincipalTextField_Insurance.setText("6999");
			...
			InsuranceRateTextField.setText("0.009");
			...
			ProductVersionCodeTextField_Insurance.setText("Bx_MOB10_J");
			...
			LoanPrincipalTextField_TreasureBox.setText("6999");
			...
			TreasureBoxRateTextField.setText("0.016");
			...
			ProductVersionCodeTextField_TreasureBox.setText("Bx_MOB10_J");
			...
			LoanPrincipalTextField_MallCoupons.setText("6999");
			...
			MallCouponsRateTextField.setText("0.1");
			...
			ProductVersionCodeTextField_MallCoupons.setText("Bx_MOB10_J");
			...
			LoanPrincipalTextField_EachPeriodShouldBeReturned.setText("6999");
			...
			InsuranceFeeTextField_EachPeriodShouldBeReturned.setText("54");
			...
			TreasureBoxFeeTextField_EachPeriodShouldBeReturned.setText("111");
			...
			ProductVersionCodeTextField_EachPeriodShouldBeReturned.setText("Bx_MOB10_J");
...
//			EvaluationOfInternalCodeRegistrationCodeTextField.setText("请输入评定内部注册代码...");
			...
			PhoneNumberTextField_SMSAuthorizationAuthentication.setText("13244721532");
			...
			SellingIDTextField.setText("666666");
			...
			LoanPrincipalTextField_RepaymentsForEachPeriod.setText("6999");
			...
			InsuranceFeeTextField_RepaymentsForEachPeriod.setText("54");
			...
			TreasureBoxFeeTextField_RepaymentsForEachPeriod.setText("111");
			...
			ComprehensiveInsuranceFeeTextField.setText("20");
			...
			ProductVersionCodeTextField_RepaymentsForEachPeriod.setText("Bx_MOB10_J");
			...
			LoanPrincipalTextField_MonthlyReturn.setText("6999");
			...
			ProductVersionCodeTextField_MonthlyReturn.setText("Bx_MOB10_J");
			...
			ContractNumberTextField_MonthlyWeShouldAlsoPrincipal.setText("16544372001");
			...
			ContractNumberTextField_MonthlyPayable.setText("16544372001");
			...
			ContractNumberTextField_MonthlyConsulting.setText("16544372001");
			...
			ContractNumberTextField_MonthlyService.setText("16544372001");
			...
			ContractNumberTextField_MonthlyLoanInterestRate.setText("16544372001");
			...
			ContractNumberTextField_ContractStateUpdate.setText("16544372001");
			...
			ContractStateTextField_ContractStateUpdate.setText("n");
			...
			PhoneNumberTextField_ShortMessageSignature.setText("13244721532");
			...
			ContractNumberTextField_PDFSigningContract.setText("16544372001");
			...
			ContractIDTextField_SignatureRecord.setText("7342104");
			...
			ContractNumberTextField_SignatureRecord.setText("16544372001");
			...
			StoredProcedureNameTextField_StoredProcedureExecution.setText("PRC_AUTO_DAILY_lzzy");
			...
			ContractNumberTextField_StoredProcedureExecution.setText("16544372001");
			...
			ContractIDTextField_StoredProcedureExecution.setText("7342104");
			...
			ContractIDTextField_ReimbursementPlan.setText("7342104");
			...
			OneTouchCreditButton = new JButton("切换至一键生成合同界面");
			OneTouchCreditButton.setFont(Constants.BASIC_FONT4);
			OneTouchCreditButton.setBounds(1416, 765, 180, 30);
			MainPanel.add(OneTouchCreditButton);
			
			HangUpProcessButton = new JButton("挂起进程");
			HangUpProcessButton.setFont(Constants.BASIC_FONT4);
			HangUpProcessButton.setBounds(1505, 803, 90, 30);
...
//				if (DataBaseHandler1_1600x900.isEmpty(contract_no)) {
...
//			}	
//		});
		DefinitionTextFieldFocusAdapter(UserInfoTextField,"请输入用户ID...");
...
//			}	
//		});		
		DefinitionTextFieldFocusAdapter(UserBoundStoreTextField,"请输入用户ID...");
...
//			}	
//		});			
		DefinitionTextFieldFocusAdapter(CityBoundContractModeTextField,"请输入城市名称...");
...
//			}	
//		});			
		DefinitionTextFieldFocusAdapter(StoreBoundCommodityTypeTextField,"请输入门店代码...");
...
//			}	
//		});				
		DefinitionTextFieldFocusAdapter(StoreBoundProductVersionTextField,"请输入门店代码...");
...
//			}	
//		});			
		DefinitionTextFieldFocusAdapter(ProductVersionCodeTextField,"请输入产品版本代码,多个请以'?','?'隔开...");
...
//			}	
//		});			
		DefinitionTextFieldFocusAdapter(ProductRegistrationCodeTextField,"请输入产品注册代码...");
...
//			}	
//		});			
		DefinitionTextFieldFocusAdapter(ContractModeTextField,"请输入合同模式...");
...
//			}	
//		});			
		DefinitionTextFieldFocusAdapter(CommodityTypeTextField,"请输入商品类型...");
...
//			}	
//		});		
		DefinitionTextFieldFocusAdapter(ProductVersionTextField,"请输入产品版本...");
...
//			}	
//		});			
		DefinitionTextFieldFocusAdapter(ProductTypeTextField,"请输入产品类型...");
...
//			}	
//		});			
		DefinitionTextFieldFocusAdapter(DownPaymentRatioTextField,"请输入首付比例...");
...
//			}	
//		});			
		DefinitionTextFieldFocusAdapter(ProductStatusTextField,"请输入产品状态...");
...
//			}	
//		});			
		DefinitionTextFieldFocusAdapter(LoanPrincipalTextField_Insurance,"请输入贷款本金...");
...
//			}	
//		});			
		DefinitionTextFieldFocusAdapter(InsuranceRateTextField,"请输入保险费率...");
...
//			}	
//		});			
		DefinitionTextFieldFocusAdapter(ProductVersionCodeTextField_Insurance,"请输入产品代码...");
...
//			}	
//		});			
		DefinitionTextFieldFocusAdapter(LoanPrincipalTextField_TreasureBox,"请输入贷款本金...");
...
//			}	
//		});			
		DefinitionTextFieldFocusAdapter(TreasureBoxRateTextField,"请输入百宝箱费率...");
...
//			}	
//		});			
		DefinitionTextFieldFocusAdapter(ProductVersionCodeTextField_TreasureBox,"请输入产品代码...");
...
//			}	
//		});			
		DefinitionTextFieldFocusAdapter(LoanPrincipalTextField_MallCoupons,"请输入贷款本金...");
...
//			}	
//		});			
		DefinitionTextFieldFocusAdapter(MallCouponsRateTextField,"请输入商城赠券费率...");
...
//			}	
//		});			
		DefinitionTextFieldFocusAdapter(ProductVersionCodeTextField_MallCoupons,"请输入产品代码...");
...
//			}	
//		});			
		DefinitionTextFieldFocusAdapter(LoanPrincipalTextField_EachPeriodShouldBeReturned,"请输入贷款本金...");
...
//			}	
//		});			
		DefinitionTextFieldFocusAdapter(InsuranceFeeTextField_EachPeriodShouldBeReturned,"请输入保险费...");
...
//			}	
//		});			
		DefinitionTextFieldFocusAdapter(TreasureBoxFeeTextField_EachPeriodShouldBeReturned,"请输入百宝箱费...");
...
//			}	
//		});			
		DefinitionTextFieldFocusAdapter(ProductVersionCodeTextField_EachPeriodShouldBeReturned,"请输入产品代码...");
...
//			}	
//		});			
		DefinitionTextFieldFocusAdapter(LoanPrincipalTextField_ComprehensiveInsurance,"请输入贷款本金...");
...
//			}	
//		});			
		DefinitionTextFieldFocusAdapter(EducationalLevelRegistrationCodeTextField,"请输入教育程度注册代码...");
...
//			}	
//		});			
		DefinitionTextFieldFocusAdapter(HousingSituationRegistrationCodeTextField,"请输入住房情况注册代码...");
...
//			}	
//		});			
		DefinitionTextFieldFocusAdapter(MaritalStatusRegistrationCodeTextField,"请输入婚姻状况注册代码...");
...
//			}	
//		});			
		DefinitionTextFieldFocusAdapter(IndustryCategoryRegistrationCodeTextField,"请输入行业类别注册代码...");
...
//			}	
//		});			
		DefinitionTextFieldFocusAdapter(UnitPropertiesRegistrationCodeTextField,"请输入单位性质注册代码...");
...
//			}	
//		});			
		DefinitionTextFieldFocusAdapter(PositionRegistrationCodeTextField,"请输入职位信息注册代码...");
...
//			}	
//		});				
		DefinitionTextFieldFocusAdapter(WorkingLifeRegistrationCodeTextField,"请输入工作年限注册代码...");
...
//			}	
//		});			
		DefinitionTextFieldFocusAdapter(SupportBankRegistrationCodeTextField,"请输入支持银行注册代码...");
...
//			}	
//		});		
		DefinitionTextFieldFocusAdapter(EvaluationOfInternalCodeRegistrationCodeTextField,"请输入评定内部注册代码...");
...
//			}	
//		});		
		DefinitionTextFieldFocusAdapter(PhoneNumberTextField_SMSAuthorizationAuthentication,"请输入手机号...");
...
//			}	
//		});			
		DefinitionTextFieldFocusAdapter(SellingIDTextField,"请输入销售ID...");
...
//			}	
//		});			
		DefinitionTextFieldFocusAdapter(LoanPrincipalTextField_RepaymentsForEachPeriod,"请输入贷款本金...");
...
//			}	
//		});			
		DefinitionTextFieldFocusAdapter(InsuranceFeeTextField_RepaymentsForEachPeriod,"请输入保险费...");
...
//			}	
//		});		
		DefinitionTextFieldFocusAdapter(TreasureBoxFeeTextField_RepaymentsForEachPeriod,"请输入百宝箱费用...");
...
//			}	
//		});			
		DefinitionTextFieldFocusAdapter(ComprehensiveInsuranceFeeTextField,"请输入全面保费用...");
...
//			}	
//		});			
		DefinitionTextFieldFocusAdapter(ProductVersionCodeTextField_RepaymentsForEachPeriod,"请输入产品代码...");
...
//			}	
//		});			
		DefinitionTextFieldFocusAdapter(LoanPrincipalTextField_MonthlyReturn,"请输入贷款本金...");
...
//			}	
//		});			
		DefinitionTextFieldFocusAdapter(ProductVersionCodeTextField_MonthlyReturn,"请输入产品代码...");
...
//			}	
//		});			
		DefinitionTextFieldFocusAdapter(ContractNumberTextField_MonthlyWeShouldAlsoPrincipal,"请输入合同号...");
...
//			}	
//		});		
		DefinitionTextFieldFocusAdapter(ContractNumberTextField_MonthlyPayable,"请输入合同号...");
...
//			}	
//		});			
		DefinitionTextFieldFocusAdapter(ContractNumberTextField_MonthlyConsulting,"请输入合同号...");
...
//			}	
//		});		
		DefinitionTextFieldFocusAdapter(ContractNumberTextField_MonthlyService,"请输入合同号...");
...
//			}	
//		});			
		DefinitionTextFieldFocusAdapter(ContractNumberTextField_MonthlyLoanInterestRate,"请输入合同号...");
...
//			}	
//		});			
		DefinitionTextFieldFocusAdapter(ContractNumberTextField_ContractStateUpdate,"请输入合同号...");
...
//			}	
//		});			
		DefinitionTextFieldFocusAdapter(ContractStateTextField_ContractStateUpdate,"请输入合同状态...");
...
//			}	
//		});			
		DefinitionTextFieldFocusAdapter(PhoneNumberTextField_ShortMessageSignature,"请输入手机号...");
...
//			}	
//		});			
		DefinitionTextFieldFocusAdapter(ContractNumberTextField_PDFSigningContract,"请输入合同号...");
...
//			}	
//		});		
		DefinitionTextFieldFocusAdapter(ContractIDTextField_SignatureRecord,"请输入合同ID...");
...
//			}	
//		});		
		DefinitionTextFieldFocusAdapter(ContractNumberTextField_SignatureRecord,"请输入合同号...");
...
//			}	
//		});		
		DefinitionTextFieldFocusAdapter(StoredProcedureNameTextField_StoredProcedureExecution,"请输入存储过程名称...");
...
//			}	
//		});			
		DefinitionTextFieldFocusAdapter(ContractNumberTextField_StoredProcedureExecution,"请输入合同号...");
...
//			}	
//		});
		DefinitionTextFieldFocusAdapter(ContractIDTextField_StoredProcedureExecution,"请输入合同ID...");
...
//			}	
//		});	
		DefinitionTextFieldFocusAdapter(ContractIDTextField_ReimbursementPlan,"请输入合同ID...");
...
//			}
//		});
		DefinitionTextFieldFocusAdapter(contractField,"请输入合同号...");
		...
		SQLArea.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				...
				if (DataBaseHandler1_1600x900.isEmpty(SQL)) {
					SQLArea.setText("请输入SQL...");
				}
			}
			@Override
			public void focusGained(FocusEvent e) {
				...
				String SQL = String.valueOf(SQLArea.getText());
				if (DataBaseHandler1_1600x900.isEqual(SQL,"请输入SQL...")) 
					SQLArea.setText("");
	...
	private void initButtonEvent() {  
		...
		UserInfoButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (DataBaseHandler1_1600x900.UserIDcompare(DataVersion,User_ID)) {
					JOptionPane.showMessageDialog(null,"查询成功！");
					DataBaseHandler1_1600x900.UserInfoButton(DataVersion,User_ID);
				}
		    }
		});
...
//					return;
//				}
//				if (DataBaseHandler_1920x1080.UserIDcompare(DataVersion,User_ID)) {
//					JOptionPane.showMessageDialog(null,"查询成功！");
//					DataBaseHandler_1920x1080.UserInfoButton(DataVersion,User_ID);
//				}
//		    }
//		});		
		...
		CityBoundContractModeButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				DataBaseHandler1_1600x900.CityBoundContractModeButton(DataVersion,city);
		    }
		});
...
//					return;
//				}
//				DataBaseHandler_1920x1080.StoreBoundCommodityTypeButton(DataVersion,POS_CODE);
//		    }
//		});		
		...
		StoreBoundProductVersionButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				DataBaseHandler1_1600x900.StoreBoundProductVersionButton(DataVersion,POS_CODE);
		    }
		});			
		...
		ProductVersionButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				DataBaseHandler1_1600x900.ProductVersionButton(DataVersion,REG_VAL_CODE,REG_NUMBER);
		    }
		});			
		...
		ProductInformationButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				DataBaseHandler1_1600x900.ProductInformationButton(DataVersion,credit_model,GOODS_CA_ID,search_type,prod_type,INIT_PAY,STATUS);
		    }
		});			
		...
		InsuranceFeeButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				DataBaseHandler1_1600x900.InsuranceFeeButton(DataVersion,LoanPrincipal,InsuranceRate,ProductVersionCode);
		    }
		});		
		...
		TreasureBoxFeeButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				DataBaseHandler1_1600x900.TreasureBoxFeeButton(DataVersion,LoanPrincipal,TreasureBoxRate,ProductVersionCode);
		    }
		});			
		...
		MallCouponsFeeButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				DataBaseHandler1_1600x900.MallCouponsFeeButton(DataVersion,LoanPrincipal,MallCouponsRate,ProductVersionCode);
		    }
		});				
		...
		EachPeriodShouldBeReturnedFeeButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				DataBaseHandler1_1600x900.EachPeriodShouldBeReturnedFeeButton(DataVersion,LoanPrincipal,InsuranceFee,TreasureBoxFee,ProductVersionCode);
		    }
		});			
...
//					return;
//				}
//				DataBaseHandler_1920x1080.EachPeriodShouldBeReturnedFeeButton(DataVersion,LoanPrincipal,InsuranceFee,TreasureBoxFee,ProductVersionCode);
//		    }
//		});			
...
//					return;
//				}
				DataBaseHandler1_1600x900.EducationalLevelButton(DataVersion,null);
		    }
		});		
...
//					return;
//				}
				DataBaseHandler1_1600x900.HousingSituationButton(DataVersion,null);
		    }
		});			
...
//					return;
//				}
				DataBaseHandler1_1600x900.MaritalStatusButton(DataVersion,null);
		    }
		});			
...
//					return;
//				}
				DataBaseHandler1_1600x900.IndustryCategoryButton(DataVersion,null);
		    }
		});		
...
//					return;
//				}
				DataBaseHandler1_1600x900.UnitPropertiesButton(DataVersion,null);
		    }
		});			
...
//					return;
//				}
				DataBaseHandler1_1600x900.PositionButton(DataVersion,null);
		    }
		});		
...
//					return;
//				}
				DataBaseHandler1_1600x900.WorkingLifeButton(DataVersion,null);
		    }
		});			
...
////					return;
////				}
//				DataBaseHandler_1920x1080.SupportBankButton(DataVersion,null);
//		    }
//		});			
...
////					return;
////				}
//				DataBaseHandler_1920x1080.EvaluationOfInternalCodeButton(DataVersion,null);
//		    }
//		});			
		...
		SMSAuthorizationAuthenticationCodeButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				DataBaseHandler1_1600x900.SMSAuthorizationAuthenticationCodeButton(DataVersion,mobile);
		    }
		});		
		...
		CustomerContractButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				DataBaseHandler1_1600x900.CustomerContractButton(DataVersion,ID_SA);
		    }
		});			
		...
		RepaymentsForEachPeriodFeeButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				DataBaseHandler1_1600x900.RepaymentsForEachPeriodFeeButton(DataVersion,LoanPrincipal,InsuranceFee,TreasureBoxFee,ComprehensiveInsuranceFee,ProductVersionCode);
		    }
		});			
		...
		MonthlyReturnFeeButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				DataBaseHandler1_1600x900.MonthlyReturnFeeButton(DataVersion,LoanPrincipal,ProductVersionCode);
		    }
		});			
		...
		MonthlyWeShouldAlsoPrincipalFeeButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				DataBaseHandler1_1600x900.MonthlyWeShouldAlsoPrincipalFeeButton(DataVersion,ContractNumber);
		    }
		});		
		...
		MonthlyPayableFeeButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				DataBaseHandler1_1600x900.MonthlyPayableFeeButton(DataVersion,ContractNumber);
		    }
		});		
		...
		MonthlyConsultingFeeAndRateButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				DataBaseHandler1_1600x900.MonthlyConsultingFeeAndRateButton(DataVersion,ContractNumber);
		    }
		});		
		...
		MonthlyServiceFeeAndRateButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				DataBaseHandler1_1600x900.MonthlyServiceFeeAndRateButton(DataVersion,ContractNumber);
		    }
		});			
		...
		MonthlyLoanInterestRateButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				DataBaseHandler1_1600x900.MonthlyLoanInterestRateButton(DataVersion,ContractNumber);
		    }
		});		
		...
		ContractStateUpdateButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				DataBaseHandler1_1600x900.ContractStateUpdateButton(DataVersion,ContractNumber,ContractState);
		    }
		});		
		...
		ShortMessageSignatureCodeButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				DataBaseHandler1_1600x900.ShortMessageSignatureCodeButton(DataVersion,mobile);
		    }
		});		
		...
		PDFSigningContractButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				DataBaseHandler1_1600x900.PDFSigningContractButton(DataVersion,ContractNumber);
		    }
		});		
		...
		SignatureRecordDeleteButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
					DataBaseHandler1_1600x900.SignatureRecordDeleteButton(DataVersion,ContractID,ContractNumber);
		...
		StoredProcedureExecutionButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				DataBaseHandler1_1600x900.StoredProcedureExecutionButton(DataVersion,StoredProcedureName,ContractNumber,ContractID);
		    }
		});			
		...
		ReimbursementPlanQueryButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				DataBaseHandler1_1600x900.ReimbursementPlanQueryButton(DataVersion,ContractID);
		    }
		});			
		...
		ReimbursementPlanDeleteButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
					DataBaseHandler1_1600x900.ReimbursementPlanDeleteButton(DataVersion,ContractID);
				} catch (SQLException e1) {
					e1.printStackTrace();
				}
		    }
		...
		InquiryContractExpensesButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (DataBaseHandler1_1600x900.contractcompare(DataVersion,contract_no)) {
					JOptionPane.showMessageDialog(null,"查询成功！");
				}
				DataBaseHandler1_1600x900.InquiryContractExpensesButton(DataVersion,contract_no);
		    }
		});	
		...
		SQLButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (DataBaseHandler1_1600x900.isEmpty1(Sql)) {
					JOptionPane.showMessageDialog(null,"查询成功！");
				}
		        DataBaseHandler1_1600x900.SQLButton(DataVersion,Sql);
		    }
		});	

		//返回至一键生成合同按钮-事件
		OneTouchCreditButton.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseExited(MouseEvent e) {
				OneTouchCreditButton.setBorder(null);
			}
			@Override
			public void mouseEntered(MouseEvent e) {
				OneTouchCreditButton.setBorder(Constants.GRAY_BORDER);
			}
			@Override
	...
	private void CreateCredit() {
		...
		OneTouchCredit1_1600x900.getInstance();
	}
	...
	public static void DefinitionTextFieldFocusAdapter(JTextField TextField,String Value){ 
		...
		TextField.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				...
				if (DataBaseHandler1_1600x900.isEmpty(Text)) {
			...
			public void focusGained(FocusEvent e) {
				...
				String Text = String.valueOf(TextField.getText());
				if (DataBaseHandler1_1600x900.isEqual(Text,Value)) {
					TextField.setText("");
