...
//			AWTUtilities.setWindowOpaque(this, false);
			...
			DataVersionBox.addItem("正式环境");  
	        DataVersionBox.addItem("测试环境");  
	        DataVersionBox.addItem("开发环境");  
...
//			passWordField.setBounds(138, 255, 195, 27);
//			passWordField.setBorder(Constants.LIGHT_GRAY_BORDER);
//			passWordField.setText("请输入密码...");
//			passWordField.setFont(Constants.BASIC_FONT4);
//			passWordField.setForeground(Color.GRAY);
//	        	
//			//用户密码Txt
//			findPassLabel = new JLabel("用户密码");
//			content.add(findPassLabel);
//			findPassLabel.setFont(Constants.BASIC_FONT);
//			findPassLabel.setBounds(340, 255, 62, 27);
...
//	}	
	...
	private void login() {
		...
		String username = userNameField.getText();
		if("请输入工号...".equals(username)|StringUtil.isEmpty(username)){
			JOptionPane.showMessageDialog(null, "请输入工号！");
			return;
		}	
		if (StringUtil.UserIDcompare(DataVersion,username)) {
			JOptionPane.showMessageDialog(null,"登录成功！");
		    super.setVisible(false);
			HomePageWindow.getInstance();
		}
